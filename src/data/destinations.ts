...
export const destinations: Destination[] = [
  ...
  {
    slug: 'ireland-ancient-east',
    name: 'מזרח ודרום אירלנד',
    nameLocal: 'Ireland\u2019s Ancient East',
    countrySlug: 'ireland',
    flag: '🇮🇪',
    center: { lat: 52.8, lng: -6.8 },
    zoom: 7,
    tagline: 'קברי מעבר בני חמשת אלפים שנה, מנזרים נטושים, טירות נורמניות ונמל היציאה של הטיטאניק',
    editorialRating: {
      score: 7.9,
      verdict: 'זה החצי ההיסטורי של אירלנד, והוא שונה מאוד מהמערב הדרמטי. אין כאן צוקים של שלוש מאות מטר, והנוף ירוק ומתגלגל אבל לא עוצר נשימה, כך שמי שמצפה לתמונות של קליפס אוף מוהר יתאכזב. הגשם כאן קבוע ובלתי צפוי בכל עונה וצריך שכבה אטומה למים גם באמצע יולי. חלק מהאתרים המרכזיים דורשים הזמנת כרטיס שבועות מראש, במיוחד ניוגריינג׳ שאליו נכנסים רק בסיור מודרך מוגבל בגודלו. המרחקים אינם גדולים אבל הכבישים המשניים צרים מאוד עם גדרות חיות משני הצדדים, והנהיגה בצד שמאל מוסיפה מתח. וכמה מהאתרים המפורסמים, בעיקר טירת בלארני, הם מכונה תיירותית עם תורים ארוכים לטקס קטן.',
    },
    summary: 'רוב הישראלים שמגיעים לאירלנד עושים את דבלין ואת המערב. הפס שבין דבלין לקורק הוא משהו אחר: כאן נמצאים קברי המעבר של עמק הבוין שקדמו לפירמידות, מנזר גלנדלוך בעמק בין שני אגמים, טירות נורמניות בקילקני ובבלארני, ונמל קוב שממנו יצאו מיליוני מהגרים אירים לאמריקה ושבו עגנה הטיטאניק בפעם האחרונה. אפשר לעשות את כל האזור במעגל של שבוע מדבלין.',
    bestSeason: 'מאי עד ספטמבר, כשהימים ארוכים ורוב האתרים פתוחים במלוא השעות. באפריל ובאוקטובר שקט יותר אבל השעות מצטמצמות. בחורף חלק מהאתרים סגורים והחשיכה מגיעה בארבע אחר הצהריים.',
    places: [
      {
        id: 'ie-newgrange',
        name: 'ניוגריינג׳',
        ...
        priceLevel: 2,
        mustSee: true,
        externalUrl: 'https://maps.google.com/?q=53.69472503662109,-6.475565433502197',
      },
      {
        id: 'ie-glendalough',
        name: 'גלנדלוך',
        nameLocal: 'Glendalough',
        category: 'nature',
        lat: 53.01027679443359,
        lng: -6.327499866485596,
        description: 'שרידי יישוב נזירי מהמאה השישית, עם מגדל עגול גבוה, בעמק בין שני אגמים בהרי ויקלו. שילוב טוב של אתר היסטורי ומסלולי הליכה מסומנים באורכים שונים. החניון מתמלא בסופי שבוע לפני עשר בבוקר, והשבילים בוציים אחרי גשם.',
        rating: 4.6,
        durationMin: 240,
        tags: ['history', 'outdoors'],
        priceLevel: 1,
        mustSee: true,
        externalUrl: 'https://maps.google.com/?q=53.01027679443359,-6.327499866485596',
      },
      {
        id: 'ie-powerscourt',
        ...
        category: 'attraction',
        lat: 53.18472290039062,
        lng: -6.186944484710693,
        description: 'גנים מטופחים בסגנון איטלקי מול הרי ויקלו, סביב בית אחוזה שנשרף ברובו ב-1974 ולא שוחזר במלואו. הגנים הם העיקר כאן והבית פחות. יום גשום מוריד מהחוויה משמעותית כי הכל בחוץ.',
        rating: 4.4,
        durationMin: 150,
        tags: ['outdoors', 'families'],
        priceLevel: 2,
        externalUrl: 'https://maps.google.com/?q=53.18472290039062,-6.186944484710693',
      },
      {
        id: 'ie-kilkenny-castle',
        name: 'טירת קילקני',
        ...
        tags: ['history', 'families'],
        priceLevel: 1,
        externalUrl: 'https://maps.google.com/?q=52.65027618408203,-7.249166488647461',
      },
      {
        id: 'ie-hook-lighthouse',
        name: 'מגדלור הוק',
        nameLocal: 'Hook Lighthouse',
        category: 'viewpoint',
        lat: 52.12380599975586,
        lng: -6.929305553436279,
        description: 'אחד המגדלורים הפעילים הוותיקים בעולם, על לשון יבשה חשופה בקצה מחוז וקספורד. העלייה בסיור מודרך במדרגות אבן צרות. המקום חשוף לרוח לגמרי ובימים סוערים הביקור לא נעים, אבל בדיוק אז הים מרשים.',
        rating: 4.3,
        durationMin: 120,
        tags: ['history', 'outdoors'],
        priceLevel: 1,
        externalUrl: 'https://maps.google.com/?q=52.12380599975586,-6.929305553436279',
      },
      {
        id: 'ie-cobh',
        name: 'קוב',
      ...
      },
      {
        ...
        tags: ['families', 'history'],
        priceLevel: 2,
        externalUrl: 'https://maps.google.com/?q=51.92890167236328,-8.570799827575684',
      },
    ],
    itinerary: [
      {
    ...
    practical: {
      flights: 'טיסות ישירות מתל אביב לדבלין בחלק מהעונות, אחרת דרך אירופה. יש גם שדה תעופה בקורק שמתאים לסיום המסלול, עם חיבורים אירופיים בלבד.',
      gettingAround: 'רכב שכור הוא הדרך המעשית היחידה לרוב האתרים כאן, שאין אליהם תחבורה ציבורית. הנהיגה בצד שמאל והכבישים המשניים צרים עם גדרות חיות שמסתירות את הראות בעיקולים, אז מתכננים זמן נסיעה נדיב. יש רכבות בין דבלין, קילקני וקורק והן נוחות, אבל הן לא מגיעות לאתרים הכפריים. חניה באתרים לרוב בתשלום.',
      kosherOverview: 'הקהילה היהודית המאורגנת באירלנד נמצאת בדבלין, והיא קטנה. מחוץ לדבלין אין באזור הזה שום שירות כשרות שאפשר להתחייב עליו. מי שצריך כשרות צריך לתכנן קניות בדבלין לפני היציאה ולינה עם מטבחון. בסופרמרקטים הגדולים אפשר למצוא מוצרים ארוזים עם הכשר בריטי או אירופי. חשוב לזכור שבשר חזיר, בייקון ופודינג שחור מופיעים כמעט בכל ארוחת בוקר אירית ובהרבה מנות פאב. תמיד יש לאמת טלפונית מול הקהילה בדבלין לפני הנסיעה.',
    },
  },
  {
    slug: 'jutland',
    ...
    countrySlug: 'denmark',
    flag: '🇩🇰',
    center: { lat: 56.4, lng: 9.5 },
    zoom: 7,
    tagline: 'החצי היבשתי של דנמרק: אבני הוויקינגים, דיונות נודדות ומקום שבו שני ימים נפגשים',
    editorialRating: {
      score: 7.7,
      verdict: 'יוטלנד היא דנמרק בלי קופנהגן, וזה בדיוק היתרון והחיסרון שלה. האזור שטוח כמעט לגמרי ומי שמחפש נוף דרמטי לא ימצא אותו כאן, למעט אזור הדיונות בצפון. הרוח על חוף הים הצפוני חזקה כמעט תמיד וגם ביולי צריך מעיל, והמים קרים מכדי לשחות בהם בנוחות. המרחקים בין קצה לקצה מגיעים לארבע שעות נסיעה, וזו מדינה יקרה שבה ארוחה פשוטה עולה יותר ממה שרוב הישראלים מצפים. חלק מהאתרים ההיסטוריים, ובראשם אבני ילינג, קטנים מאוד ביחס לחשיבותם ההיסטורית וייתכן שתעמדו מולם עשר דקות. ולגולנד היא אטרקציה נהדרת לילדים ומיותרת לגמרי בלעדיהם, במחיר גבוה.',
    },
    summary: 'רוב מי שטס לדנמרק רואה את קופנהגן ואת צפון זילנד. יוטלנד היא חצי האי שמחובר לגרמניה, והיא החלק האחר של המדינה: אורהוס כעיר שנייה עם מוזיאון אמנות ידוע ועיר-מוזיאון של בתים היסטוריים, ריבה כעיר הוותיקה בדנמרק, אבני ילינג שנחשבות לתעודת הלידה של הממלכה, ובצפון הרחוק הדיונה הנודדת ראבייר מילה והלשון שבה הים הצפוני והקאטגט נפגשים. זה אזור לרכב שכור ולקצב איטי.',
    bestSeason: 'מאי עד ספטמבר. יולי ואוגוסט הכי חמים אבל גם העמוסים ביותר בתיירות דנית וגרמנית פנימית. באפריל ובאוקטובר קר ורוחי מאוד. בחורף חלק מהאתרים החופיים סגורים.',
    places: [
      {
        id: 'dk-aros',
        name: 'מוזיאון ארוס',
        nameLocal: 'ARoS Aarhus Kunstmuseum',
        category: 'museum',
        lat: 56.15388870239258,
        lng: 10.19961071014404,
        description: 'מוזיאון האמנות של אורהוס, שמזוהה בעיקר עם מסדרון טבעות זכוכית צבעונית על הגג שממנו רואים את העיר בגוונים משתנים. האוסף עצמו טוב אך לא ענק, והטבעת היא הסיבה שרוב האנשים מגיעים. בשעות השיא יש צפיפות ממש על הגג.',
        rating: 4.5,
        durationMin: 150,
        tags: ['art'],
        priceLevel: 2,
        mustSee: true,
        externalUrl: 'https://maps.google.com/?q=56.15388870239258,10.19961071014404',
      },
      {
        id: 'dk-den-gamle-by',
        name: 'דן גאמלה בי',
        nameLocal: 'Den Gamle By',
        category: 'museum',
        lat: 56.15900039672852,
        lng: 10.19099998474121,
        description: 'מוזיאון פתוח באורהוס שבו הועברו בתים אמיתיים מרחבי דנמרק ונבנו מחדש כרחובות שלמים משנים שונות, כולל שכונה משנות השבעים. עובד עם שחקנים בתלבושות, מה שחלק מהמבקרים אוהבים וחלק מוצאים מלאכותי. טוב מאוד למשפחות.',
        rating: 4.5,
        durationMin: 210,
        tags: ['history', 'families'],
        priceLevel: 2,
      ...
      },
      {
        ...
        tags: ['history'],
        priceLevel: 0,
        externalUrl: 'https://maps.google.com/?q=55.75666809082031,9.41944408416748',
      },
      {
        id: 'dk-legoland',
        name: 'לגולנד בילונד',
        nameLocal: 'Legoland Billund',
        category: 'attraction',
        lat: 55.73555374145508,
        lng: 9.126111030578613,
        description: 'פארק השעשועים הראשון של לגו, במקום שבו החברה נוסדה. מכוון לילדים בגילי ארבע עד אחת עשרה, ומעליהם רבים משתעממים. המחיר גבוה, התורים בקיץ ארוכים, וכדאי להזמין כרטיסים מראש ולהגיע עם הפתיחה.',
        rating: 4.3,
        durationMin: 420,
        tags: ['families'],
        priceLevel: 3,
      ...
      },
      {
        ...
        tags: ['history'],
        priceLevel: 1,
        externalUrl: 'https://maps.google.com/?q=55.32833480834961,8.762222290039062',
      },
      {
        id: 'dk-rabjerg-mile',
        name: 'ראבייר מילה',
        nameLocal: 'Råbjerg Mile',
        category: 'nature',
        lat: 57.64805603027344,
        lng: 10.4061107635498,
        description: 'הדיונה הנודדת הגדולה בצפון אירופה, שזזה מזרחה כמה מטרים בשנה וקוברת בדרכה שטחים שלמים. ההליכה מהחניון אל הפסגה קצרה אבל בחול עמוק ומתישה יותר משנראה. הרוח כאן חזקה מאוד ומעיפה חול, אז שווה משקפיים.',
        rating: 4.4,
        durationMin: 120,
        tags: ['outdoors', 'families'],
        priceLevel: 0,
        externalUrl: 'https://maps.google.com/?q=57.64805603027344,10.4061107635498',
      },
      {
        id: 'dk-grenen',
        name: 'גרנן',
        nameLocal: 'Grenen',
        category: 'viewpoint',
        lat: 57.74388885498047,
        lng: 10.64750003814697,
        description: 'הנקודה הצפונית ביותר של דנמרק, לשון חול צרה שבה נפגשים הים הצפוני והקאטגט וגלים משני הכיוונים מתנגשים זה בזה. מגיעים בהליכה של כחצי שעה מהחניון או בטרקטור-אוטובוס בתשלום. אסור להיכנס למים בנקודת המפגש בגלל זרמים.',
        rating: 4.5,
        durationMin: 150,
        tags: ['outdoors'],
        priceLevel: 1,
        mustSee: true,
        externalUrl: 'https://maps.google.com/?q=57.74388885498047,10.64750003814697',
      },
    ],
    itinerary: [
      {
      ...
      {
        day: 3,
        title: 'ריבה והחוף המערבי',
        placeIds: ['dk-ribe'],
        notes: 'נסיעה של כשעה. אחר הצהריים אפשר להמשיך לחוף הים הצפוני, שרוחי מאוד.',
      },
      {
        day: 4,
        title: 'צפונה לדיונות',
    ...
    practical: {
      flights: 'אין טיסות ישירות מישראל ליוטלנד. הדרך המקובלת היא טיסה לקופנהגן ומשם רכבת לאורהוס בכשלוש שעות או טיסת פנים קצרה. יש גם שדות תעופה קטנים באורהוס ובבילונד עם חיבורים אירופיים.',
      gettingAround: 'רכב שכור הוא הפתרון המעשי, במיוחד לצפון ולחוף המערבי שבהם התחבורה הציבורית דלילה. יש רשת רכבות טובה בין הערים הגדולות אבל לא אל האתרים הכפריים. הכבישים מצוינים והנהיגה קלה, אבל שימו לב שרוכבי אופניים בכל מקום ויש להם זכות קדימה. חניה ברוב האתרים חינם או זולה.',
      kosherOverview: 'הקהילה היהודית המאורגנת בדנמרק והשירותים הכשרים נמצאים כמעט כולם בקופנהגן, שהיא כשלוש שעות נסיעה מיוטלנד. באזור עצמו אין מסעדה או חנות שאפשר להתחייב עליה. הפתרון המעשי הוא קניות בקופנהגן לפני היציאה, לינה עם מטבחון, ומוצרים ארוזים עם הכשר אירופי מהסופרים הגדולים. חשוב לדעת שבשר חזיר הוא בסיס המטבח הדני היומיומי ומופיע גם במנות שנראות נייטרליות, ושחלק גדול מהמנות המקומיות הן דגים. תמיד יש לאמת טלפונית מול הקהילה בקופנהגן לפני הנסיעה.',
    },
  },
  {
    slug: 'north-island-nz',
    name: 'האי הצפוני של ניו זילנד',
    nameLocal: 'North Island / Te Ika-a-Māui',
    countrySlug: 'new-zealand',
    flag: '🇳🇿',
    center: { lat: -38.5, lng: 175.5 },
    zoom: 6,
    tagline: 'געשיות פעילה, תרבות מאורית חיה, הר בודד מושלם ואתרי צילום מהסרטים',
    editorialRating: {
      score: 8.4,
      verdict: 'האי הצפוני פחות דרמטי מהדרומי ומי שראה את פיורדלנד ואת אורקי ירגיש שהנוף כאן רך יותר, אבל הוא מפצה בגעשיות פעילה ובתרבות מאורית שהיא חלק מהיומיום ולא מוזיאון. יש כמה דברים שצריך לדעת: ריח הגופרית באזור רוטורואה נוכח כל הזמן וחלק מהאנשים לא מסתדרים איתו; חציית טונגרירו, המסלול המפורסם, נסגרת לעיתים קרובות בגלל מזג אוויר ודורשת הסעה מתואמת לשני הקצוות; הר טאראנקי מוסתר בעננים רוב ימות השנה ואפשר לבלות שם יומיים בלי לראות אותו; הובטון הוא סט צילום מסחרי לגמרי שמבקרים בו רק בסיור מודרך יקר ובקצב מוכתב; המרחקים גדולים והכבישים מפותלים כך שמאה קילומטר לוקחים הרבה יותר משנראה במפה; והמחירים בניו זילנד גבוהים מאוד, במיוחד ללינה בעונה.',
    },
    summary: 'האתר כבר מכסה את קווינסטאון ואת האי הדרומי. האי הצפוני הוא החצי השני, והוא שונה לגמרי: כאן נמצא הלב הגעשי של המדינה עם גייזרים, בריכות בוץ רותחות ואגמים תרמיים, כאן נמצאים רוב היישובים המאוריים והמקומות המרכזיים בהיסטוריה של המדינה, וכאן גם אתרי הצילום המוכרים ביותר של שר הטבעות. אפשר לחבר את שני האיים בטיול אחד ארוך או לעשות את הצפון בפני עצמו בשבוע עד עשרה ימים.',
    bestSeason: 'נובמבר עד אפריל, שהם הקיץ והסתיו של חצי הכדור הדרומי. דצמבר-ינואר הכי חמים אבל גם עונת החופשות המקומית והכל מלא ויקר. החורף המקומי, יוני עד אוגוסט, גשום ורוב מסלולי ההרים סגורים או מסוכנים.',
    places: [
      {
        id: 'nz-whakarewarewa',
        name: 'וואקארווארווה',
        ...
        priceLevel: 2,
        mustSee: true,
        externalUrl: 'https://maps.google.com/?q=-38.16222381591797,176.2563934326172',
      },
      {
        id: 'nz-huka-falls',
        name: 'מפלי הוקה',
        nameLocal: 'Huka Falls',
        category: 'nature',
        lat: -38.64949798583984,
        lng: 176.0896759033203,
        description: 'לא מפל גבוה אלא מפרץ צר שדרכו נדחס כל נהר הוואיקטו בעוצמה אדירה, בצבע תכלת חלבי. הצפייה מגשר וממסלול הליכה קצר וחינמי לאורך הנהר. עצירה של פחות משעה, אבל אחת המרשימות בדרך.',
        rating: 4.5,
        durationMin: 60,
        tags: ['outdoors', 'families'],
        priceLevel: 0,
        externalUrl: 'https://maps.google.com/?q=-38.64949798583984,176.0896759033203',
      },
      {
        id: 'nz-tongariro',
        name: 'הפארק הלאומי טונגרירו',
        nameLocal: 'Tongariro National Park',
        category: 'nature',
        lat: -39.29083251953125,
        lng: 175.5622253417969,
        description: 'הפארק הלאומי הוותיק בניו זילנד, עם שלושה הרי געש פעילים ואגמים בצבע טורקיז מלאכותי כמעט. חציית טונגרירו היא מסלול יום של כתשעה עשר קילומטרים שדורש כושר, ציוד והסעה מתואמת בין שני הקצוות, והיא נסגרת תכופות במזג אוויר גרוע.',
        rating: 4.8,
        durationMin: 480,
        tags: ['outdoors'],
        priceLevel: 1,
        mustSee: true,
        externalUrl: 'https://maps.google.com/?q=-39.29083251953125,175.5622253417969',
      },
      {
        id: 'nz-hobbiton',
        name: 'סט הצילומים הובטון',
        nameLocal: 'Hobbiton Movie Set',
        category: 'attraction',
        lat: -37.85749816894531,
        lng: 175.6797180175781,
        description: 'הכפר של ההוביטים, שנבנה מחדש כקבע בחווה פרטית באזור מאטאמאטה. נכנסים רק בסיור מודרך בתשלום גבוה, בקצב מוכתב ובלי אפשרות להסתובב חופשי. מי שלא אוהד של הסרטים ימצא כאן פחות ערך ממה שהמחיר מרמז. מזמינים מראש.',
        rating: 4.4,
        durationMin: 180,
        tags: ['families'],
        priceLevel: 3,
        externalUrl: 'https://maps.google.com/?q=-37.85749816894531,175.6797180175781',
      },
      {
        id: 'nz-taranaki',
        name: 'הר טאראנקי',
        nameLocal: 'Mount Taranaki',
        category: 'nature',
        lat: -39.29639053344727,
        lng: 174.0647277832031,
        description: 'הר געש כמעט סימטרי לחלוטין שעומד בודד מול הים, אחד הנופים היפים בניו זילנד כשהוא נגלה. הבעיה היא שהוא מכוסה בעננים ברוב ימות השנה. יש מסלולי הליכה בכל הרמות למרגלותיו, והטיפוס לפסגה מסוכן ודורש ניסיון אלפיני.',
        rating: 4.6,
        durationMin: 300,
        tags: ['outdoors'],
        priceLevel: 0,
        externalUrl: 'https://maps.google.com/?q=-39.29639053344727,174.0647277832031',
      },
      {
        id: 'nz-waitangi',
        name: 'וואיטנגי',
        ...
        tags: ['history'],
        priceLevel: 2,
        externalUrl: 'https://maps.google.com/?q=-35.26610946655273,174.0800018310547',
      },
    ],
    itinerary: [
      {
      ...
      },
      {
        day: 5,
        title: 'טונגרירו',
        placeIds: ['nz-tongariro'],
        notes: 'אם עושים את החצייה, מזמינים הסעה מראש ובודקים תחזית בערב שלפני. תוכנית גיבוי חובה.',
      },
      {
        day: 6,
        title: 'החוף המערבי',
        placeIds: ['nz-taranaki'],
        notes: 'כארבע שעות נסיעה מערבה. תנו לעצמכם שני לילות כדי להגדיל את הסיכוי לראות את ההר.',
      },
    ],
    practical: {
      flights: 'אין טיסות ישירות מישראל. הנסיעה כוללת לפחות שתי החלפות, לרוב דרך אסיה או דרך אוסטרליה, ולוקחת מעל עשרים וארבע שעות. נוחתים באוקלנד, שהיא נקודת ההתחלה של המסלול הזה.',
      gettingAround: 'רכב שכור או קרוואן הם הדרך המעשית. הנהיגה בצד שמאל, הכבישים ברובם חד-מסלוליים ומפותלים, וזמני הנסיעה ארוכים משמעותית ממה שמפות מראות. יש קווי אוטובוס בין הערים אבל הם לא מגיעים לרוב האתרים. תדלוק ומזון בפנים האי דלילים, אז לא מחכים לרזרבה.',
  ...
  {
    slug: 'slovenia-karst-east',
    name: 'סלובניה שמעבר לבלד: קארסט ועמקי המזרח',
    nameLocal: 'Kras in vzhodna Slovenija',
    countrySlug: 'slovenia',
    flag: '🇸🇮',
    center: { lat: 46.0, lng: 14.5 },
    zoom: 9,
    tagline: 'מערות ענק, אגם שנעלם, כפרי רועים על רמה וכרייה בת חמש מאות שנה',
    editorialRating: {
      score: 7.8,
      verdict: 'זה הצד של סלובניה שאף אחד לא מצלם, וזו בדיוק הסיבה ללכת אליו, אבל צריך לבוא עם ציפיות נכונות. אין כאן אתר אחד שיעצור לכם את הנשימה כמו אגם בלד, אלא רצף של מקומות קטנים ומעניינים. המערות דורשות סיור מודרך בשעות קבועות, קר בהן גם בקיץ וצריך שכבה חמה, וחלק מהמסלולים כוללים מאות מדרגות ולא נגישים. אגם צרקניצה הוא תופעה עונתית ובחלק מהשנה פשוט אין שם אגם, מה שמאכזב מי שלא בדק. המרחקים קצרים אבל הכבישים המשניים צרים ומפותלים ובלי רכב כמעט אי אפשר. וההסבר באתרים הקטנים לא תמיד קיים באנגלית ברמה טובה.',
    },
    summary: 'האתר כבר מכסה את אגם בלד ואת האלפים היוליאניים, שכוללים גם את ליובליאנה, פיראן, פוסטוינה ופרדיאמה. זו הפינה השנייה של סלובניה: אזור הקארסט בדרום-מערב עם מערכת המערות של שקוצ׳יאן שהיא מהמרשימות באירופה, האגם הנעלם של צרקניצה שמתמלא ומתרוקן לפי עונות הגשם, עיירת המכרות אידריה שהייתה בין מכרות הכספית הגדולים בעולם, ובמזרח עמקים אלפיניים ורמות רועים שנשארו כמעט בלי תיירות.',
    bestSeason: 'מאי עד אוקטובר. אביב וסתיו נעימים במיוחד וגם מגדילים את הסיכוי לראות את אגם צרקניצה מלא. בקיץ חם בשפלה אבל נעים ברמות. בחורף חלק מהאתרים מצמצמים שעות.',
    places: [
      {
        id: 'si-skocjan',
        name: 'מערות שקוצ׳יאן',
        nameLocal: 'Škocjanske jame',
        category: 'nature',
        lat: 45.66666793823242,
        lng: 14.0,
        description: 'מערכת מערות שבה נהר תת-קרקעי חצב קניון פנימי ענק, שחוצים אותו על גשר תלוי גבוה. אתר מורשת עולמית, ולדעת רבים מרשים יותר מפוסטוינה המפורסמת ממנה כי הוא פראי ולא ממונע. הסיור כולל מאות מדרגות, קר בפנים כל השנה, וצילום אסור בחלקים גדולים.',
        rating: 4.8,
        durationMin: 180,
        tags: ['outdoors', 'history'],
        priceLevel: 2,
        mustSee: true,
        externalUrl: 'https://maps.google.com/?q=45.66666793823242,14.0',
      },
      {
        id: 'si-cerknica',
        name: 'אגם צרקניצה',
        nameLocal: 'Cerkniško jezero',
        category: 'nature',
        lat: 45.75222396850586,
        lng: 14.38500022888184,
        description: 'אגם עונתי שמתמלא בגשמי הסתיו והאביב ונעלם כמעט לגמרי בקיץ, כי המים מתנקזים למערכת קארסטית מתחתיו. כשהוא מלא זו אחת מזירות הציפורים הטובות באזור, וכשהוא ריק זה שדה ירוק. בדקו את המצב לפני שנוסעים במיוחד.',
        rating: 4.2,
        durationMin: 150,
        tags: ['outdoors'],
        priceLevel: 0,
        externalUrl: 'https://maps.google.com/?q=45.75222396850586,14.38500022888184',
      },
      {
        id: 'si-sneznik-castle',
        name: 'טירת סנז׳ניק',
        ...
        tags: ['history'],
        priceLevel: 1,
        externalUrl: 'https://maps.google.com/?q=45.68283843994141,14.46931648254395',
      },
      {
        id: 'si-idrija',
        name: 'אידריה',
        ...
        priceLevel: 1,
        mustSee: true,
        externalUrl: 'https://maps.google.com/?q=46.00249862670898,14.02750015258789',
      },
      {
        id: 'si-velika-planina',
        name: 'ולִיקה פלאנינה',
        nameLocal: 'Velika planina',
        category: 'viewpoint',
        lat: 46.29694366455078,
        lng: 14.65194416046143,
        description: 'רמת מרעה גבוהה עם כפר בקתות רועים בסגנון מסורתי, שאליה עולים ברכבל ואז ברכבל קטן נוסף או ברגל. בקיץ הרועים עדיין שם ומוכרים מוצרי חלב. ביום מעונן הרמה עטופה בערפל ולא רואים כלום, ובסופי שבוע קיציים היא מלאה מקומיים.',
        rating: 4.4,
        durationMin: 240,
        tags: ['outdoors', 'families'],
        priceLevel: 2,
        externalUrl: 'https://maps.google.com/?q=46.29694366455078,14.65194416046143',
      },
      {
        id: 'si-logarska',
        name: 'עמק לוגרסקה',
        ...
        category: 'nature',
        lat: 46.39853286743164,
        lng: 14.63081073760986,
        description: 'עמק קרחוני צר וסגור באלפים הקאמניים, עם דרך אחת שנכנסת ומסתיימת במפל בקצה. הכניסה ברכב בתשלום, ואפשר גם באופניים. שקט מאוד בהשוואה לאזור בלד, אבל אין כאן הרבה שירותים ומעט מאוד אפשרויות אוכל.',
        rating: 4.6,
        durationMin: 300,
        tags: ['outdoors'],
        priceLevel: 1,
        mustSee: true,
        externalUrl: 'https://maps.google.com/?q=46.39853286743164,14.63081073760986',
      },
      {
        id: 'si-ptujska-gora',
        name: 'פטויסקה גורה',
        ...
        tags: ['history', 'art'],
        priceLevel: 0,
        externalUrl: 'https://maps.google.com/?q=46.35348129272461,15.76105308532715',
      },
    ],
    itinerary: [
      {
      ...
      {
        day: 5,
        title: 'האלפים הקאמניים',
        placeIds: ['si-logarska'],
        notes: 'יום שלם בעמק. קחו אוכל, אין הרבה מסעדות בפנים.',
      },
      {
        day: 6,
        title: 'מזרחה',
    ...
    practical: {
      flights: 'טיסות ישירות מתל אביב לליובליאנה בחלק מהעונות, אחרת דרך וינה, זאגרב או ונציה, שכולן במרחק נסיעה סביר. הקווים העונתיים משתנים משנה לשנה וצריך לבדוק מה פעיל.',
  ...
  },
  {
    ...
    nameLocal: 'אזור האגמים של פינלנד',
    countrySlug: 'finland',
    flag: '🇫🇮',
    center: { lat: 61.9, lng: 28.5 },
    zoom: 7,
    tagline: 'עשרות אלפי אגמים, יערות ללא סוף ומבצר ימי-ביניים על אי בלב המים',
    editorialRating: {
      score: 8.4,
      verdict: 'אזור האגמים הוא הפינלנד האמיתית, אבל צריך לדעת למה באים. הנוף הוא וריאציות אין-סופיות על אותו נושא עצמו: מים שקטים, יער מחטניים, עוד מים. מי שמחפש הרים או דרמה ויזואלית ישתעמם תוך יומיים. העונה הממשית קצרה מאוד, בערך יוני עד אוגוסט; בשאר השנה חלק מהאתרים פשוט סגורים והתחבורה הציבורית דלילה מאוד. המרחקים בין האתרים גדולים והכבישים מסתובבים סביב אגמים, כך שמרחק שנראה קצר במפה לוקח הרבה זמן. פינלנד יקרה, ובעיירות קטנות הבחירה הקולינרית מצומצמת מאוד. ובקיץ יש יתושים, הרבה יתושים.',
    },
    summary: 'אזור האגמים במזרח פינלנד הוא רשת עצומה של אגמים, איים ומצרים צרים שנותרה מהקרחונים. במרכזו עומדת סאוונלינה עם מבצר אולאווילינה מהמאה ה-15, ומסביב פארקים לאומיים שמסתכמים למאות קילומטרים של יער ומים. זה טיול רכב קלאסי, עם קוטג׳ים על שפת המים, קיאקים וסאונה בערב.',
    bestSeason: 'יוני עד אוגוסט לקיץ הלבן ולפסטיבל האופרה בסאוונלינה; ספטמבר לצבעי הסתיו ביערות',
    places: [
      {
        id: 'fi-savonlinna',
        name: 'Savonlinna',
        nameLocal: 'סאוונלינה',
        category: 'attraction',
        lat: 61.86805725097656,
        lng: 28.88611030578613,
        description: 'עיירת הבירה הקטנה של אזור האגמים, בנויה על כמה איים במערכת אגם סיימה. נקודת המוצא הטבעית לכל האזור, עם שוק נמל קיץי והפלגות לאגם.',
        rating: 4.4,
        durationMin: 180,
        tags: ['families', 'outdoors'],
        priceLevel: 0,
        externalUrl: 'https://maps.google.com/?q=61.86805725097656,28.88611030578613',
      },
      {
        id: 'fi-olavinlinna',
        name: 'Olavinlinna Castle',
        nameLocal: 'מבצר אולאווילינה',
        category: 'attraction',
        ...
        priceLevel: 2,
        mustSee: true,
        externalUrl: 'https://maps.google.com/?q=61.86388778686523,28.9011116027832',
      },
      {
        id: 'fi-punkaharju',
        name: 'Punkaharju Ridge',
        nameLocal: 'רכס פונקהאריו',
        category: 'nature',
        lat: 61.75,
        lng: 29.39999961853027,
        description: 'רכס קרחוני צר באורך שבעה קילומטרים שעובר בין שני אגמים, מכוסה אורנים ובמקומות מסוימים רוחב הקרקע מגיע לעשרות מטרים בלבד. מנוף הדגל של פינלנד.',
        rating: 4.5,
        durationMin: 120,
        tags: ['outdoors', 'romantic'],
        priceLevel: 0,
        mustSee: true,
        externalUrl: 'https://maps.google.com/?q=61.75,29.39999961853027',
      },
      {
        id: 'fi-linnansaari',
        name: 'Linnansaari National Park',
        nameLocal: 'פארק לאומי לינאנסארי',
        category: 'nature',
        lat: 62.11055374145508,
        lng: 28.50944519042969,
        description: 'פארק לאומי שכמעט כולו מים ואיים קטנים, בית גידוליו של כלב הים הטבעתי של סיימה, מהכלביים הנדירים בעולם. מגיעים בסירה או בקיאק בלבד.',
        rating: 4.4,
        durationMin: 300,
        tags: ['outdoors'],
        priceLevel: 1,
        externalUrl: 'https://maps.google.com/?q=62.11055374145508,28.50944519042969',
      },
      {
        id: 'fi-koli',
        name: 'Koli National Park',
        nameLocal: 'פארק לאומי קולי',
        category: 'viewpoint',
        lat: 63.05749893188477,
        lng: 29.88722229003906,
        description: 'הנקודה הגבוהה בדרום פינלנד, עם תצפית מפורסמת מעל אגם פיילינן. הנוף מכאן צויר על ידי אמני הרומנטיקה הלאומית הפינית. העלייה קצרה אבל תלולה.',
        rating: 4.7,
        durationMin: 240,
        tags: ['outdoors'],
        priceLevel: 0,
        mustSee: true,
        externalUrl: 'https://maps.google.com/?q=63.05749893188477,29.88722229003906',
      },
      {
        id: 'fi-repovesi',
        name: 'Repovesi National Park',
        nameLocal: 'פארק לאומי רפווסי',
        category: 'nature',
        lat: 61.18333435058594,
        lng: 26.88333320617676,
        description: 'פארק של צוקי גרניט, יער ואגמים קטנים, עם מסלולי הליכה מסומנים וגשר תלוי על מצר המים. אחד הפארקים הנגישים ביותר מדרום המדינה.',
        rating: 4.5,
        durationMin: 300,
        tags: ['outdoors'],
        priceLevel: 0,
        externalUrl: 'https://maps.google.com/?q=61.18333435058594,26.88333320617676',
      },
      {
        id: 'fi-verla',
        name: 'Verla Mill',
        nameLocal: 'מפעל הנייר ורלה',
        category: 'museum',
        lat: 61.06194305419922,
        lng: 26.64083290100098,
        description: 'מפעל עיסה וקרטון משלהי המאה ה-19 שפעל עד 1964 ונשמר כמעט בשלמותו, אתר מורשת עולם של אונסקו. פתוח לסיורים בעונת הקיץ בלבד.',
        rating: 4.2,
        durationMin: 90,
        tags: ['history'],
        priceLevel: 1,
        externalUrl: 'https://maps.google.com/?q=61.06194305419922,26.64083290100098',
      },
    ],
    itinerary: [
      {
        day: 1,
        title: 'סאוונלינה והמבצר',
        placeIds: ['fi-savonlinna', 'fi-olavinlinna'],
        notes: 'הסיור המודרך במבצר נמכר מראש בעונה; בימי הפסטיבל ביולי החצר סגורה למבקרים.',
      },
      {
        day: 2,
        title: 'רכס פונקהאריו',
      ...
      },
      {
        ...
        title: 'צפונה אל קולי',
        placeIds: ['fi-koli'],
        notes: 'נסיעה ארוכה מאוד, עדיף לישון באזור ולעלות לתצפית בזריחה.',
      },
      {
        day: 5,
        title: 'רפווסי',
      ...
      },
      {
        ...
        title: 'ורלה',
        placeIds: ['fi-verla'],
        notes: 'עצירה קצרה בדרך להלסינקי; בדקו שעות פתיחה לפני הנסיעה.',
      },
    ],
    practical: {
  ...
  {
    slug: 'west-estonia-islands',
    name: 'West Estonia & the Islands',
    nameLocal: 'מערב אסטוניה והאיים',
    countrySlug: 'estonia',
    flag: '🇪🇪',
    center: { lat: 58.5, lng: 23.0 },
    zoom: 8,
    tagline: 'מבצר אבן על אי, מכתש מטאוריט ובתי קיץ עץ מול הים הבלטי',
    editorialRating: {
      score: 8.0,
      verdict: 'זה טיול שקט מאוד, וזה גם היתרון וגם החיסרון שלו. אין כאן שום אתר שעוצר נשימה חוץ אולי ממבצר קורסארה, והנוף שטוח לגמרי - הנקודה הגבוהה בכל סארמה היא כמה עשרות מטרים. המעבורות לאיים תלויות מזג אוויר ובקיץ צריך להזמין מקום לרכב שבועות מראש. העונה קצרה: מאמצע ספטמבר ועד מאי חלק גדול מהמסעדות, המוזיאונים והלינה פשוט סגורים, והאיים נהיים ריקים לחלוטין. הים הבלטי כאן רדוד וקר, וימי הרחצה ספורים. מי שמצפה לאסטוניה של טאלין המימי-ביניימית יגלה אזור כפרי לגמרי.',
    },
    summary: 'החוף המערבי של אסטוניה והאיים הגדולים שלפניו הם עולם נפרד מטאלין: כפרי דייגים, טחנות רוח, יערות ערער וביצות. סארמה, האי הגדול, שמרה על אופי מבודד גם בתקופה הסובייטית כשהייתה אזור צבאי סגור, ולכן החופים והכפרים בה נשארו כמעט ללא פיתוח. זה טיול רכב איטי, עם מעבורות, שבילי הליכה ולילות שקטים במיוחד.',
    bestSeason: 'יוני עד אמצע ספטמבר; מחוץ לחלון הזה רוב האתרים והמעבורות פועלים בתדירות מצומצמת',
    places: [
      {
        id: 'ee-kuressaare',
        name: 'Kuressaare Castle',
        nameLocal: 'מבצר קורסארה',
        category: 'attraction',
        lat: 58.25,
        ...
        priceLevel: 1,
        mustSee: true,
        externalUrl: 'https://maps.google.com/?q=58.25,22.48332977294922',
      },
      {
        id: 'ee-kaali',
        name: 'Kaali Crater',
        nameLocal: 'מכתש קאאלי',
        category: 'nature',
        lat: 58.37277603149414,
        lng: 22.6694450378418,
        description: 'מכתש פגיעת מטאוריט מלפני כארבעת אלפים שנה, כיום אגם עגול קטן מוקף עצים. אתר פולחן קדום, וקטן בהרבה ממה שמצטייר בתמונות.',
        rating: 4.0,
        durationMin: 45,
        tags: ['outdoors', 'history'],
        priceLevel: 0,
        externalUrl: 'https://maps.google.com/?q=58.37277603149414,22.6694450378418',
      },
      {
        id: 'ee-panga',
        name: 'Panga Cliff',
        nameLocal: 'צוק פאנגה',
        category: 'viewpoint',
        lat: 58.57017517089844,
        lng: 22.28799819946289,
        description: 'הצוק הגבוה בסארמה, קיר גיר בגובה של כעשרים מטר מעל הים הבלטי. שוליים לא מגודרים, זהירות עם ילדים.',
        rating: 4.3,
        durationMin: 60,
        tags: ['outdoors'],
        priceLevel: 0,
        externalUrl: 'https://maps.google.com/?q=58.57017517089844,22.28799819946289',
      },
      {
        id: 'ee-vilsandi',
        name: 'Vilsandi National Park',
        nameLocal: 'פארק לאומי וילסאנדי',
        category: 'nature',
        lat: 58.37861251831055,
        lng: 21.87722206115723,
        description: 'הפארק הלאומי הוותיק באסטוניה, אזור של מאות איונים קטנים וגן עדן לצפרות. אחד המקומות הטובים בבלטיות לצפייה בעופות ים.',
        rating: 4.2,
        durationMin: 240,
        tags: ['outdoors'],
        priceLevel: 0,
        externalUrl: 'https://maps.google.com/?q=58.37861251831055,21.87722206115723',
      },
      {
        id: 'ee-haapsalu',
        name: 'Haapsalu',
        ...
        tags: ['history', 'romantic'],
        priceLevel: 0,
        externalUrl: 'https://maps.google.com/?q=58.93944549560547,23.54083251953125',
      },
      {
        id: 'ee-matsalu',
        name: 'Matsalu National Park',
        nameLocal: 'פארק לאומי מאטסאלו',
        category: 'nature',
        lat: 58.7599983215332,
        lng: 23.59694480895996,
        description: 'מפרץ רדוד ואזור ביצות שהוא אחת מתחנות הנדידה החשובות באירופה. במאי ובספטמבר עוברים כאן מאות אלפי עופות מים.',
        rating: 4.3,
        durationMin: 180,
        tags: ['outdoors'],
        priceLevel: 0,
      ...
      {
        id: 'ee-soomaa',
        name: 'Soomaa National Park',
        nameLocal: 'פארק לאומי סומאה',
        category: 'nature',
        lat: 58.44083404541016,
        lng: 25.10555648803711,
        description: 'ארץ הביצות, עם שבילי לוחות עץ מעל שדות כבול ענקיים. באביב מגיעה כאן העונה החמישית, הצפה שמכסה יערות ודרכים ומאפשרת שיט בסירות.',
        rating: 4.4,
        durationMin: 240,
        tags: ['outdoors'],
        priceLevel: 0,
        externalUrl: 'https://maps.google.com/?q=58.44083404541016,25.10555648803711',
      },
    ],
    itinerary: [
      {
      ...
      },
      {
        day: 5,
        title: 'וילסאנדי',
        placeIds: ['ee-vilsandi'],
        notes: 'הגישה לאיים תלויה בגאות ובמזג אוויר; בררו במרכז המבקרים באותו בוקר.',
      },
      {
        day: 6,
    ...
    practical: {
      flights: 'טסים לטאלין ומשם נוסעים מערבה. אין טיסות ישירות מהארץ לאסטוניה בכל השנה, לרוב טסים בקונקשן דרך אירופה או דרך ריגה.',
  ...
  },
  {
    ...
    name: 'Kurzeme & Zemgale',
    nameLocal: 'קורזמה וזמגאלה',
    countrySlug: 'latvia',
    flag: '🇱🇻',
    center: { lat: 56.9, lng: 22.3 },
    zoom: 8,
    tagline: 'ארמון ברוק בלב שדות, מפל רחב בעיירת עץ וחוף בלטי שומם עד האופק',
    editorialRating: {
      score: 7.8,
      verdict: 'לטביה שמחוץ לריגה היא אזור כפרי ודליל, ומי שמגיע בציפייה להמשך של ריגה יתאכזב. חוץ מארמון רונדאלה אין כאן אתר ברמה בינלאומית, והערים הגדולות - ונטספילס וליאפיה - הן ערי נמל תעשייתיות עם פינות יפות בודדות ולא ערים יפות בכללותן. הכבישים בין האתרים ארוכים, שטוחים ומשעממים, וחלקם עדיין חצץ. מחוץ ליולי ואוגוסט הרבה מוזיאונים ומסעדות עובדים בשעות מצומצמות או סגורים לגמרי. הים הבלטי כאן קר גם באמצע הקיץ. מצד שני, זה אחד המקומות השקטים באמת שנשארו באירופה, ובחודשי הקיץ אפשר לצעוד קילומטרים על חוף בלי לפגוש אף אחד.',
    },
    summary: 'קורזמה, החבל המערבי של לטביה, וזמגאלה שמדרום לריגה מרכיבות יחד את לטביה הכפרית: יערות אורנים, חופים ריקים, כפרי דייגים ליבים ואחוזות אצולה משלטון הדוכסות. במרכז עומד ארמון רונדאלה, יצירה של האדריכל שבנה את ארמונות סנקט פטרבורג, ובקצה הצפוני כף קולקה שבו נפגשים שני ימים. זהו טיול רכב שקט מאוד עם מרחקים גדולים.',
    bestSeason: 'סוף מאי עד אמצע ספטמבר; בחורף האזור אפור, קפוא וכמעט הכל סגור',
    places: [
      {
        id: 'lv-rundale',
        name: 'Rundāle Palace',
        nameLocal: 'ארמון רונדאלה',
        category: 'attraction',
        ...
        priceLevel: 2,
        mustSee: true,
        externalUrl: 'https://maps.google.com/?q=56.41379928588867,24.02479934692383',
      },
      {
        id: 'lv-bauska',
        name: 'Bauska Castle',
        nameLocal: 'מצודת באוסקה',
        category: 'attraction',
        ...
        tags: ['history'],
        priceLevel: 1,
        externalUrl: 'https://maps.google.com/?q=56.40361022949219,24.17361068725586',
      },
      {
        id: 'lv-kuldiga',
        name: 'Kuldīga',
      ...
      },
      {
        ...
        nameLocal: 'ונטספילס',
        category: 'attraction',
        lat: 57.39055633544922,
        lng: 21.57333374023438,
        description: 'עיר נמל עם חוף חול ארוך ומצודה מהמאה ה-13 מתקופת המסדר הליבוני. עיר מסודרת ונקייה במיוחד, אך גם תעשייתית ולא ציורית ברובה.',
        rating: 4.0,
        durationMin: 180,
        tags: ['families', 'outdoors'],
        priceLevel: 0,
        externalUrl: 'https://maps.google.com/?q=57.39055633544922,21.57333374023438',
      },
      {
        id: 'lv-kolka',
        name: 'Cape Kolka',
        nameLocal: 'כף קולקה',
        category: 'viewpoint',
        lat: 57.75894546508789,
        lng: 22.60474967956543,
        description: 'הנקודה שבה נפגשים מפרץ ריגה והים הבלטי הפתוח, עם קו גלים כפול שנראה מהחוף. אזור החוף הליבי, קהילה קטנטנה עם שפה נפרדת שכמעט נכחדה.',
        rating: 4.3,
        durationMin: 90,
        tags: ['outdoors'],
        priceLevel: 0,
        externalUrl: 'https://maps.google.com/?q=57.75894546508789,22.60474967956543',
      },
      {
        id: 'lv-slitere',
        name: 'Slītere National Park',
        nameLocal: 'פארק לאומי סליטרה',
        category: 'nature',
        lat: 57.62416839599609,
        lng: 22.2944450378418,
        description: 'יערות, דיונות עתיקות וכפרי דייגים נטושים לאורך החוף. באזור נותרו מתקנים סובייטיים נטושים משנות המדינה הסגורה.',
        rating: 4.2,
        durationMin: 240,
        tags: ['outdoors'],
        priceLevel: 0,
        externalUrl: 'https://maps.google.com/?q=57.62416839599609,22.2944450378418',
      },
      {
        id: 'lv-liepaja',
        name: 'Liepāja',
    ...
    itinerary: [
      ...
      {
        day: 3,
        title: 'ונטספילס והחוף',
        placeIds: ['lv-ventspils'],
        notes: 'יום נוח למשפחות עם ילדים; החוף פה מהטובים בלטביה.',
      },
      {
        day: 4,
  ...
  {
    slug: 'western-lithuania',
    name: 'Western Lithuania',
    nameLocal: 'מערב ליטא',
    countrySlug: 'lithuania',
    flag: '🇱🇹',
    center: { lat: 55.6, lng: 21.7 },
    zoom: 8,
    tagline: 'רצועת חול באורך תשעים קילומטר, גבעה מכוסה מאות אלפי צלבים ודלתא של עופות נודדים',
    editorialRating: {
      score: 8.1,
    ...
    summary: 'מערב ליטא הוא עולם אחר לגמרי מווילנה: לשון החול הקורונית שמפרידה בין הים הבלטי ללגונה, כפרי דייגים בצבעי עץ, יערות אורנים ודלתא רחבה של נהר נמונאס שהיא אחד ממסדרונות הנדידה הגדולים באירופה. בפנים הארץ עומדת גבעת הצלבים, אתר עלייה לרגל שהצבא הסובייטי הרס שלוש פעמים והמקומיים בנו מחדש בכל פעם.',
    bestSeason: 'יוני עד ספטמבר לחוף וללשון; אפריל ומאי או ספטמבר ואוקטובר לנדידת הציפורים בדלתא',
    places: [
      {
        id: 'lt-curonian-spit',
        name: 'Curonian Spit',
        nameLocal: 'הלשון הקורונית',
        category: 'nature',
        lat: 55.27444458007812,
        lng: 20.97083282470703,
        description: 'רצועת חול צרה באורך כתשעים ושמונה קילומטרים שמפרידה בין הים הבלטי ללגונה הקורונית, אתר מורשת עולם של אונסקו. הצד הליטאי הוא כמחצית מאורכה.',
        rating: 4.7,
        durationMin: 360,
        tags: ['outdoors', 'families'],
        priceLevel: 1,
        mustSee: true,
        externalUrl: 'https://maps.google.com/?q=55.27444458007812,20.97083282470703',
      },
      {
        id: 'lt-nida',
        name: 'Nida',
        nameLocal: 'נידה',
        category: 'attraction',
        lat: 55.3033332824707,
        lng: 21.00555610656738,
        description: 'הכפר הראשי בלשון הקורונית, עם בתי דייגים אדומים וכחולים ודיונת פרנידיס מעליו. תומאס מאן בנה כאן בית קיץ שנשמר כמוזיאון.',
        rating: 4.6,
        durationMin: 240,
        tags: ['romantic', 'outdoors'],
        priceLevel: 1,
        mustSee: true,
        externalUrl: 'https://maps.google.com/?q=55.3033332824707,21.00555610656738',
      },
      {
        id: 'lt-hill-of-crosses',
        name: 'Hill of Crosses',
        nameLocal: 'גבעת הצלבים',
        category: 'attraction',
        ...
        tags: ['history'],
        priceLevel: 0,
        externalUrl: 'https://maps.google.com/?q=56.01527786254883,23.41666603088379',
      },
      {
        id: 'lt-palanga',
        name: 'Palanga',
        nameLocal: 'פאלנגה',
        category: 'attraction',
        lat: 55.91666793823242,
        lng: 21.0666675567627,
        description: 'עיר הנופש הראשית של ליטא, עם חוף חול רחב, מזח ארוך ופארק בוטני גדול סביב אחוזת טישקביץ. הומה ורועשת מאוד בקיץ.',
        rating: 4.1,
        durationMin: 240,
        tags: ['families', 'nightlife'],
        priceLevel: 1,
      ...
      {
        id: 'lt-zemaitija',
        name: 'Žemaitija National Park',
        nameLocal: 'פארק לאומי ז׳מייטיה',
        category: 'nature',
        lat: 56.04861068725586,
        lng: 21.88888931274414,
        description: 'פארק סביב אגם פלאטליי, עם יערות, כפרים כפריים ובסיס טילים סובייטי תת-קרקעי שהפך למוזיאון של המלחמה הקרה.',
        rating: 4.3,
        durationMin: 300,
        tags: ['outdoors', 'history'],
        priceLevel: 1,
        externalUrl: 'https://maps.google.com/?q=56.04861068725586,21.88888931274414',
      },
      {
        id: 'lt-nemunas-delta',
        name: 'Nemunas Delta Regional Park',
        nameLocal: 'דלתת נמונאס',
        category: 'nature',
        lat: 55.29999923706055,
        lng: 21.39999961853027,
        description: 'אזור ביצות והצפות בשפך נהר נמונאס ללגונה, אחת מנקודות הנדידה החשובות באירופה. באביב חלק מהכפרים מוצפים ונעים ביניהם בסירות.',
        rating: 4.3,
        durationMin: 240,
        tags: ['outdoors'],
        priceLevel: 0,
      ...
      },
      {
        ...
        nameLocal: 'רמבינאס',
        category: 'viewpoint',
        lat: 55.08750152587891,
        lng: 22.02111053466797,
        description: 'גבעה מעל נהר נמונאס שהייתה אתר פולחן פגאני עתיק, כיום פארק אזורי עם תצפית אל עבר גבול קלינינגרד.',
        rating: 4.0,
        durationMin: 90,
        tags: ['outdoors', 'history'],
        priceLevel: 0,
    ...
    itinerary: [
      ...
      },
      {
        day: 6,
        title: 'רמבינאס',
        placeIds: ['lt-rambynas'],
        notes: 'עצירה קצרה בדרך חזרה מזרחה לכיוון קובנה או וילנה.',
      },
    ],
    practical: {
  ...
  {
    slug: 'northern-bulgaria',
    name: 'Northern Bulgaria & the Balkan Range',
    nameLocal: 'צפון בולגריה ורכס הבלקן',
    countrySlug: 'bulgaria',
    flag: '🇧🇬',
    center: { lat: 43.1, lng: 25.3 },
    zoom: 7,
    tagline: 'סלעי חול אדומים, פסל רוכב מהמאה השמינית ואנדרטה קומוניסטית נטושה על פסגה',
    editorialRating: {
      score: 7.9,
    ...
    summary: 'צפון בולגריה, בין הדנובה לרכס הבלקן, הוא החלק הפחות מתויר של המדינה. פה נמצאות בירות הממלכה הבולגרית הראשונה והשנייה, כנסיות חצובות בסלע, כפרי בתי אבן משוחזרים מהתחייה הלאומית, ואנדרטאות מהמאה העשרים שממשיכות לעורר ויכוח פוליטי. הנוף עובר בין מישורי דנובה שטוחים לרכס הרים מיוער וגבוה.',
    bestSeason: 'מאי עד יוני ומאמצע ספטמבר עד אוקטובר; יולי ואוגוסט חמים מאוד במישור ובחורף מעברי ההרים נסגרים',
    places: [
      {
        id: 'bg-belogradchik',
        name: 'Belogradchik Rocks',
        nameLocal: 'סלעי בלוגראדצ׳יק',
        category: 'nature',
        lat: 43.62083435058594,
        lng: 22.68499946594238,
        description: 'עמודי אבן חול אדומה בגובה עשרות מטרים שנפרשים על פני קילומטרים, ובתוכם משולבת מצודה שנבנתה על ידי הרומאים והורחבה בתקופה העות׳מאנית.',
        rating: 4.7,
        durationMin: 240,
        tags: ['outdoors', 'history'],
        priceLevel: 1,
        mustSee: true,
        externalUrl: 'https://maps.google.com/?q=43.62083435058594,22.68499946594238',
      },
      {
        id: 'bg-madara',
        name: 'Madara Rider',
        nameLocal: 'הרוכב ממדארה',
        category: 'attraction',
        ...
        tags: ['history'],
        priceLevel: 1,
        externalUrl: 'https://maps.google.com/?q=43.27669525146484,27.11955642700195',
      },
      {
        id: 'bg-ivanovo',
        name: 'Rock-hewn Churches of Ivanovo',
        nameLocal: 'כנסיות הסלע של איבאנובו',
        category: 'attraction',
        ...
        priceLevel: 1,
        mustSee: true,
        externalUrl: 'https://maps.google.com/?q=43.71666717529297,25.96666717529297',
      },
      {
        id: 'bg-devetashka',
        name: 'Devetashka Cave',
        nameLocal: 'מערת דבטשקה',
        category: 'nature',
        lat: 43.23638916015625,
        lng: 24.89555549621582,
        description: 'מערה עצומה עם פתחי תקרה שדרכם חודר אור, מאוכלסת במושבת עטלפים גדולה. בעונת הקינון חלקים ממנה נסגרים לביקור.',
        rating: 4.4,
        durationMin: 90,
        tags: ['outdoors'],
        priceLevel: 0,
        externalUrl: 'https://maps.google.com/?q=43.23638916015625,24.89555549621582',
      },
      {
        id: 'bg-tryavna',
        name: 'Tryavna',
        ...
        tags: ['history', 'romantic'],
        priceLevel: 0,
        externalUrl: 'https://maps.google.com/?q=42.866943359375,25.5',
      },
      {
        id: 'bg-shipka',
        name: 'Shipka Pass',
        nameLocal: 'מעבר שיפקה',
        category: 'viewpoint',
        lat: 42.75500106811523,
        lng: 25.31888961791992,
        description: 'מעבר הרים ברכס הבלקן שבו התנהלו קרבות מכריעים במלחמת רוסיה-תורכיה של 1877. אנדרטת החירות בראשו נגישה בעלייה של מאות מדרגות.',
        rating: 4.4,
        durationMin: 150,
        tags: ['history', 'outdoors'],
        priceLevel: 1,
        externalUrl: 'https://maps.google.com/?q=42.75500106811523,25.31888961791992',
      },
      {
        id: 'bg-buzludzha',
        name: 'Buzludzha Monument',
        nameLocal: 'אנדרטת בוזלודז׳ה',
        category: 'attraction',
    ...
    itinerary: [
      ...
      },
      {
        ...
        title: 'מדארה',
        placeIds: ['bg-madara'],
        notes: 'קחו משקפת; התבליט נמצא גבוה על הצוק.',
      },
      {
        day: 5,
  ...
  },
  {
    slug: 'lori-tavush',
    name: 'Lori & Tavush',
    nameLocal: 'לורי וטבוש',
    countrySlug: 'armenia',
    flag: '🇦🇲',
    center: { lat: 41.0, lng: 44.8 },
    zoom: 9,
    tagline: 'מנזרי אבן מהמאה העשירית מעל קניון עמוק, ביערות צפון ארמניה',
    editorialRating: {
      score: 8.3,
      verdict: 'צפון ארמניה מציע את המנזרים היפים במדינה, אבל הסביבה סביבם קשה. קניון דבד מלא בערי תעשייה סובייטיות מתפוררות כמו אלאוורדי, עם מפעלי נחושת נטושים וזיהום ניכר, וזה לא נוף פסטורלי. הכבישים הצרים אל המנזרים תלולים ומפותלים, וחלקם במצב ירוד; ברכב פרטי נמוך זה לא נעים. המרחקים במפה מטעים מאוד, ונסיעה של ארבעים קילומטר יכולה לקחת שעה וחצי. אין כמעט תשתית תיירותית מחוץ לדיליז׳אן, והבחירה בלינה ובאוכל מוגבלת. השילוט באנגלית דל ורוב התושבים דוברים רוסית וארמנית בלבד. בחורף הכבישים ההרריים מסוכנים.',
    },
    summary: 'מחוזות לורי וטבוש בצפון ארמניה, לאורך קניון נהר דבד ועד יערות דיליז׳אן, מרכזים את הריכוז הצפוף ביותר של אדריכלות ארמנית מימי הביניים. הגפטאט וסנהין, שניהם אתרי מורשת עולם, נבנו במאה העשירית ושמרו על מכלולים שלמים של כנסיות, ספריות ומגדלי פעמונים. זה אזור ירוק ומיוער בהרבה משאר ארמניה, ופחות מתויר.',
    bestSeason: 'מאי עד אוקטובר; באביב ובסתיו הצבעים בקניון יפים במיוחד ובחורף חלק מהדרכים חסומות',
    places: [
      {
        id: 'am-haghpat',
        name: 'Haghpat Monastery',
        nameLocal: 'מנזר הגפטאט',
        category: 'attraction',
        ...
        priceLevel: 0,
        mustSee: true,
        externalUrl: 'https://maps.google.com/?q=41.09388732910156,44.71194458007812',
      },
      {
        id: 'am-sanahin',
        name: 'Sanahin Monastery',
        nameLocal: 'מנזר סנהין',
        category: 'attraction',
        ...
        priceLevel: 0,
        mustSee: true,
        externalUrl: 'https://maps.google.com/?q=41.08722305297852,44.66611099243164',
      },
      {
        id: 'am-akhtala',
        name: 'Akhtala Monastery',
        nameLocal: 'מנזר אחטלה',
        category: 'attraction',
        ...
        tags: ['history', 'art'],
        priceLevel: 0,
        externalUrl: 'https://maps.google.com/?q=41.15057754516602,44.76391983032227',
      },
      {
        id: 'am-odzun',
        name: 'Odzun Church',
        nameLocal: 'כנסיית אודזון',
        category: 'attraction',
        ...
        tags: ['history'],
        priceLevel: 0,
        externalUrl: 'https://maps.google.com/?q=41.05084991455078,44.61641693115234',
      },
      {
        id: 'am-kobayr',
        name: 'Kobayr Monastery',
        nameLocal: 'מנזר קובאיר',
        category: 'attraction',
        ...
        tags: ['history', 'outdoors'],
        priceLevel: 0,
        externalUrl: 'https://maps.google.com/?q=41.00583267211914,44.63666534423828',
      },
      {
        id: 'am-haghartsin',
        name: 'Haghartsin Monastery',
        nameLocal: 'מנזר הגרצין',
        category: 'attraction',
        ...
        priceLevel: 0,
        mustSee: true,
        externalUrl: 'https://maps.google.com/?q=40.76848983764648,44.89087677001953',
      },
      {
        id: 'am-goshavank',
        name: 'Goshavank',
    ...
    practical: {
      flights: 'טסים לירוואן, שיש אליה קווים ישירים מתל אביב, ומשם נסיעה של כשלוש שעות צפונה. אפשר גם להיכנס מגאורגיה דרך מעבר בגרטאשן שנמצא ממש בקצה האזור.',
      gettingAround: 'רכב שכור או נהג מקומי. מרשוטקות מגיעות רק לערים הגדולות בקניון ולא למנזרים עצמם. חלק מהדרכים אל המנזרים תלולות מאוד, ורכב עם סיבולת גבוהה עדיף.',
      kosherOverview: 'אין כשרות בצפון ארמניה. הקהילה היהודית הקטנה של המדינה נמצאת בירוואן, שם יש בית כנסת ואפשר לנסות לתאם מראש. מחוץ לבירה אין דבר. המטבח הארמני נשען הרבה על בשר בקר וכבש בגריל, אך גם עשיר מאוד בירקות, עשבי תיבול, קטניות ולחם לוואש, כך שלצמחונים יחסית נוח. אין לסמוך על שום עסק בלי בדיקה טלפונית שלכם לפני הנסיעה, וכדאי להביא מלאי מהארץ.',
    },
  },
  {
    slug: 'oaxaca',
    ...
    countrySlug: 'mexico',
    flag: '🇲🇽',
    center: { lat: 16.9, lng: -96.6 },
    zoom: 8,
    tagline: 'עיר קולוניאלית צבעונית, ערי זאפוטקים על ראשי גבעות ומפלים מאובנים של מינרלים',
    editorialRating: {
      score: 8.8,
      verdict: 'אואחקה היא אחת החוויות התרבותיות החזקות במקסיקו, אבל היא לא קלה. הגובה בעיר הוא כאלף וחמש מאות מטר וחלק מהמבקרים מרגישים את זה ביומיים הראשונים. הכביש מהעיר לחוף עובר בהרים ולוקח שש שעות לפחות עם פיתולים אינסופיים שגורמים למחלת דרכים; טיסה פנימית קצרה עדיפה. ההגעה לאירבה אל אגואה הייתה חסומה בעבר בגלל סכסוכי קרקע בין קהילות מקומיות, ולפעמים היא עדיין נסגרת בהתראה קצרה - חובה לבדוק ביום עצמו. בעונות שיא, ובעיקר סביב חג המתים בסוף אוקטובר, המחירים מזנקים והעיר עמוסה מאוד. חסימות כבישים בעקבות מחאות מורים ואיכרים הן חלק מהחיים באזור ויכולות לשבש תוכניות ליום שלם. ולבסוף, האוכל כאן חריף באמת, לא חריף תיירותי.',
    },
    summary: 'מדינת אואחקה שבדרום מקסיקו היא לב התרבויות הזאפוטקית והמישטקית, ואחד האזורים הילידיים ביותר במדינה - עם עשרות שפות מקומיות שמדוברות עד היום. עיר אואחקה עצמה היא אתר מורשת עולם עם כנסיות ברוק ושווקים גדולים, ומסביבה פזורים אתרים ארכיאולוגיים על ראשי גבעות, כפרי אומנים המתמחים כל אחד במלאכה אחת, ומזרקות מינרלים מאובנות. בקצה הדרומי מגיעים אל חופי האוקיינוס השקט.',
    bestSeason: 'נובמבר עד אפריל לעונה היבשה; סוף אוקטובר לחג המתים אך במחירים ובעומס גבוהים במיוחד',
    places: [
      {
        id: 'mx-oaxaca-city',
        name: 'Oaxaca City',
        nameLocal: 'העיר אואחקה',
        category: 'attraction',
      ...
      },
      {
        ...
        priceLevel: 1,
        mustSee: true,
        externalUrl: 'https://maps.google.com/?q=17.04388809204102,-96.76777648925781',
      },
      {
        id: 'mx-mitla',
        name: 'Mitla',
        ...
        tags: ['history', 'art'],
        priceLevel: 1,
        externalUrl: 'https://maps.google.com/?q=16.92722129821777,-96.35944366455078',
      },
      {
        id: 'mx-hierve-el-agua',
        name: 'Hierve el Agua',
        nameLocal: 'אירבה אל אגואה',
        category: 'nature',
        lat: 16.86551856994629,
        lng: -96.2760009765625,
        description: 'מפל מאובן של מינרלים, מדרון לבן ענק שנוצר ממעיינות עשירי סידן, ומעליו בריכות טבעיות עם נוף אל העמק. הגישה נסגרת לעיתים בגלל סכסוכי קרקע מקומיים.',
        rating: 4.6,
        durationMin: 240,
        tags: ['outdoors'],
        priceLevel: 1,
        mustSee: true,
        externalUrl: 'https://maps.google.com/?q=16.86551856994629,-96.2760009765625',
      },
      {
        id: 'mx-tule',
        name: 'Árbol del Tule',
        nameLocal: 'עץ הטולה',
        category: 'nature',
        lat: 17.04649925231934,
        lng: -96.6361083984375,
        description: 'עץ ברוש מונטסומה עם היקף הגזע הגדול בעולם, יותר מארבעים מטר. עצירה קצרה בדרך מזרחה, כחצי שעה מספיקה.',
        rating: 4.2,
        durationMin: 45,
        tags: ['families', 'outdoors'],
        priceLevel: 0,
        externalUrl: 'https://maps.google.com/?q=17.04649925231934,-96.6361083984375',
      },
      {
        id: 'mx-yagul',
        name: 'Yagul',
        ...
        tags: ['history', 'outdoors'],
        priceLevel: 1,
        externalUrl: 'https://maps.google.com/?q=16.95833396911621,-96.45027923583984',
      },
      {
        id: 'mx-puerto-escondido',
        name: 'Puerto Escondido',
        nameLocal: 'פוארטו אסקונדידו',
        category: 'attraction',
        lat: 15.8619441986084,
        lng: -97.07166290283203,
        description: 'עיירת חוף על האוקיינוס השקט, מוקד גלישה בינלאומי בזכות שובר הגלים בזיקטלה. הזרמים כאן חזקים מאוד וחלק מהחופים מסוכנים לשחייה.',
        rating: 4.4,
        durationMin: 480,
        tags: ['outdoors', 'nightlife'],
        priceLevel: 1,
        externalUrl: 'https://maps.google.com/?q=15.8619441986084,-97.07166290283203',
      },
    ],
    itinerary: [
      {
      ...
      },
      {
        day: 2,
        title: 'מונטה אלבן',
        placeIds: ['mx-monte-alban'],
        notes: 'צאו מוקדם בבוקר; בצהריים אין צל בכלל באתר.',
      },
      {
        day: 3,
        title: 'עמק טלאקולולה',
    ...
    practical: {
      flights: 'אין טיסות ישירות מהארץ למקסיקו. טסים בקונקשן למקסיקו סיטי ומשם טיסה פנימית של שעה לאואחקה, או נסיעה ארוכה באוטובוס לילה. לפוארטו אסקונדידו יש טיסות פנימיות קצרות.',
      gettingAround: 'בעיר הכל בהליכה. לאתרים בעמק אפשר רכב שכור, מוניות קולקטיביות או סיורים מאורגנים ליום. בין העיר לחוף מומלץ לטוס ולא לנסוע. חסימות כבישים בעקבות מחאות הן שכיחות ויכולות לעכב יום שלם.',
      kosherOverview: 'אין תשתית כשרות באואחקה. הקהילה היהודית המאורגנת של מקסיקו מרוכזת במקסיקו סיטי, ושם יש מסעדות כשרות, מרכולים וקהילות גדולות - זו הנקודה היחידה במדינה שאפשר להצטייד בה. באואחקה עצמה אין דבר. הצד החיובי הוא שהמטבח המקומי מבוסס מאוד על תירס, שעועית, ירקות, אבוקדו וצ׳ילי, כך שקל למצוא אוכל צמחוני, אך שומן חזיר משמש בבישול בהרבה מקומות גם במנות שנראות צמחוניות. תכננו הצטיידות במקסיקו סיטי ובדקו כל עסק בעצמכם לפני הנסיעה.',
    },
  },
  {
    slug: 'fergana-valley',
    ...
    countrySlug: 'uzbekistan',
    flag: '🇺🇿',
    center: { lat: 40.7, lng: 71.6 },
    zoom: 8,
    tagline: 'ארמון ח׳אן, בתי מלאכה של משי וקרמיקה, ועמק חקלאי צפוף שכמעט אין בו תיירים',
    editorialRating: {
      score: 7.6,
      verdict: 'עמק פרגנה הוא לא ההמשך של סמרקנד ובוכרה, וחשוב להבין את זה מראש. אין כאן כיכרות מונומנטליות ומעט מאוד אדריכלות מרשימה - רוב הערים בעמק הן ערים סובייטיות מודרניות ולא ציוריות, ומה שמושך אליהן הוא בתי המלאכה והשווקים ולא המבנים. הכביש מטשקנט עובר במעבר קמצ׳יק שנסגר לעיתים בחורף, והנסיעה ארוכה. העמק שמור פוליטית והוא האזור השמרני ביותר באוזבקיסטן; נשים ילבשו בגדים צנועים, ואת הגבולות עם קירגיזסטן וטג׳יקיסטן, שנחתכים בעמק בצורה מוזרה עם מובלעות, כדאי לבדוק לפני כל תנועה. בקיץ החום מגיע בקלות לארבעים מעלות. השילוט באנגלית כמעט לא קיים ורוסית עוזרת מאוד.',
    },
    summary: 'עמק פרגנה במזרח אוזבקיסטן הוא האזור הצפוף והפורה במרכז אסיה, מוקף הרים משלושה כיוונים. פה נמצאים מרכזי המלאכה הוותיקים של המדינה: אריגת משי בעבודת יד במרגילן, קרמיקה כחולה במסורת בת מאות שנים, וסכינים מגולפות בצ׳וסט. בקוקנד עומד ארמון הח׳אנים האחרון של האזור. זה טיול לאנשים שכבר ראו את דרך המשי הקלאסית ורוצים את החיים היומיומיים מאחוריה.',
    bestSeason: 'אפריל עד יוני וספטמבר עד אוקטובר; יולי ואוגוסט חמים מאוד ובחורף מעבר קמצ׳יק נסגר לפעמים',
    places: [
      {
        id: 'uz-kokand',
        name: 'Kokand',
        ...
        priceLevel: 1,
        mustSee: true,
        externalUrl: 'https://maps.google.com/?q=40.52861022949219,70.94249725341797',
      },
      {
        id: 'uz-margilan',
        name: 'Margilan',
        ...
        priceLevel: 1,
        mustSee: true,
        externalUrl: 'https://maps.google.com/?q=40.47111129760742,71.72472381591797',
      },
      {
        id: 'uz-fergana',
        name: 'Fergana',
        nameLocal: 'פרגנה',
        category: 'attraction',
        lat: 40.38639068603516,
        lng: 71.78639221191406,
        description: 'עיר הבירה של המחוז, שנבנתה כעיר מצודה רוסית במאה ה-19 עם שדרות רחבות ובניינים קולוניאליים. בסיס נוח ללינה, אך אין בה אתרים היסטוריים גדולים.',
        rating: 3.9,
        durationMin: 120,
        tags: ['foodie'],
        priceLevel: 1,
        externalUrl: 'https://maps.google.com/?q=40.38639068603516,71.78639221191406',
      },
      {
        id: 'uz-quva',
        name: 'Quva',
      ...
      },
      {
        ...
        tags: ['history'],
        priceLevel: 0,
        externalUrl: 'https://maps.google.com/?q=40.78333282470703,72.33333587646484',
      },
      {
        id: 'uz-namangan',
        name: 'Namangan',
      ...
      },
      {
        ...
        nameLocal: 'צ׳וסט',
        category: 'attraction',
        lat: 40.99777603149414,
        lng: 71.24028015136719,
        description: 'עיירת מלאכה המפורסמת בסכיני פלדה בעבודת יד ובכובעי הדופי הרקומים בשחור ולבן, סמל לאומי אוזבקי. בתי המלאכה קטנים ומפוזרים בעיירה.',
        rating: 4.0,
        durationMin: 120,
        tags: ['art'],
        priceLevel: 0,
        externalUrl: 'https://maps.google.com/?q=40.99777603149414,71.24028015136719',
      },
    ],
    itinerary: [
      {
      ...
      },
      {
        ...
        title: 'אנדיז׳אן',
        placeIds: ['uz-andijan'],
        notes: 'קרוב מאוד לגבול הקירגיזי; בדקו מצב מעברים לפני כל תנועה גבולית.',
      },
      {
        day: 5,
        title: 'נמנגן וצ׳וסט',
    ...
    practical: {
      flights: 'טסים לטשקנט, שיש אליה קווים ישירים מתל אביב בחלק מהעונות, ומשם רכבת מהירה או נסיעה של כחמש שעות דרך מעבר קמצ׳יק. יש גם טיסות פנימיות קצרות לפרגנה ולנמנגן.',
      gettingAround: 'הדרך הפשוטה היא מוניות משותפות בין הערים בעמק, שהן זולות ותכופות. אפשר גם נהג לכל היום במחיר סביר. הגבולות עם קירגיזסטן וטג׳יקיסטן חוצים את העמק בצורה מסובכת עם מובלעות, אז אל תסמכו על מסלול שנראה קצר במפה.',
      kosherOverview: 'אין תשתית כשרות בעמק פרגנה. הקהילות היהודיות ההיסטוריות של אוזבקיסטן היו בבוכרה, סמרקנד וטשקנט, ורק בטשקנט נותרה היום קהילה פעילה עם בית כנסת שאפשר לנסות לתאם איתה מראש. בעמק אין דבר. המטבח המקומי מבוסס על כבש ובקר, ופלוב מבושל כמעט תמיד בשומן זנב כבש; חזיר נדיר יחסית אך יש בשר שאינו כשר בכל מקום. יש הרבה לחם, ירקות, פירות יבשים ואגוזים בשווקים. הביאו מלאי מהארץ, ואל תסתמכו על שום עסק בלי לוודא בעצמכם מראש.',
    },
  },
  {
    slug: 'lumbini-terai',
    name: 'Lumbini and the Terai',
    nameLocal: 'לומביני ומישור הטראי',
    countrySlug: 'nepal',
    flag: '🇳🇵',
    center: { lat: 27.3, lng: 84.0 },
    zoom: 7,
    tagline: 'נפאל בלי הרים: מקום הולדתו של הבודהה, ג׳ונגלים ופילים במישור החם שבגבול הודו',
    editorialRating: {
      score: 7.4,
      verdict:
        'זו נפאל אחרת לגמרי, ומי שמגיע בשביל ההימלאיה יתאכזב. הטראי הוא מישור שטוח לחלוטין, חם ומאובק, בלי שום נוף הרים. העונה החמה מגיעה ל-40 מעלות ולחות גבוהה, ובקיץ המונסון חלק מהדרכים נחסמות. יש כאן מלריה ודנגי בעונות מסוימות, וצריך להתייעץ עם רופא לפני הנסיעה. המרחקים ענקיים: כביש מהנדרה חוצה את כל המישור ונסיעה בין שני אתרים יכולה לקחת שש-שבע שעות בגלל משאיות איטיות ומצב כביש משתנה. תשתית התיירות מינימלית מחוץ ללומביני ולברדייה, ורמת בתי המלון נמוכה. לומביני עצמה מפתיעה לרעה חלק מהמבקרים: האזור המנזרי הוא פארק מודרני ענק ומפוזר שבנו מדינות שונות מאז שנות ה-80, ולא אתר עתיק. עמוד אשוקה ומקדש מאיה דווי הם ליבת האתר האמיתית והם קטנים. בשמורות הטבע לא מובטחת שום תצפית: נמרים כמעט לא נראים, וגם קרנפים ופילים תלויים במזל ובעונה. מנגד, זה אחד האזורים הזולים בנפאל, כמעט בלי תיירות מערבית, והמפגש עם התרבות המישורית שקרובה יותר להודו מאשר לקטמנדו הוא אמיתי.',
    },
    summary:
      'רוב הנוסעים לנפאל רואים רק את קטמנדו, פוקהרה והרכסים. מישור הטראי, הרצועה השטוחה לאורך הגבול ההודי, הוא נפאל השנייה: כאן נולד סידהרתא גאוטמה שהפך לבודהה, כאן שרדו יערות סאל עם קרנפים חד-קרניים ופילי בר, וכאן החיים דומים יותר לביהאר ההודית מאשר להרים. הנסיעה משלבת את לומביני ואת אתרי הילדות של הבודהה, את שמורות ברדייה וקושי טאפו, את עיירת הגבעות טנסן שמשקיפה על המישור, ואת ג׳נקפור עם המקדש ההינדי הצבעוני שלה. זו נסיעה לסקרנים, לא לחובבי נוף דרמטי.',
    bestSeason: 'אוקטובר עד מרץ. נובמבר-פברואר הם החודשים הנוחים ביותר, עם ימים נעימים ולילות קרירים וראות טובה בשמורות. מרץ-מאי חמים מאוד. יוני-ספטמבר עונת מונסון עם שיטפונות ודרכים חסומות.',
    places: [
      {
        id: 'np-lumbini',
        name: 'Lumbini',
        ...
        description:
          'אתר מורשת עולמית של אונסק״ו ומקום הולדתו של הבודהה לפי המסורת. הליבה ההיסטורית היא מקדש מאיה דווי ועמוד האבן שהציב הקיסר אשוקה במאה השלישית לפנה״ס. סביבם נבנה מאז שנות ה-80 אזור מנזרי ענק שבו כל מדינה בודהיסטית הקימה מנזר בסגנון שלה, מתאילנד ועד גרמניה. השטח עצום ושטוח ומומלץ לשכור אופניים או ריקשה.',
        rating: 4.4,
        durationMin: 240,
        tags: ['history'],
        priceLevel: 1,
        mustSee: true,
        externalUrl: 'https://maps.google.com/?q=27.48138809204102,83.27583312988281',
      },
      {
        id: 'np-tilaurakot',
        name: 'Tilaurakot',
        nameLocal: 'טילאוראקוט',
        category: 'attraction',
        lat: 27.57999992370605,
        lng: 83.08000183105469,
        description:
          'אתר ארכיאולוגי שרבים מזהים אותו עם קפילוואסטו, העיר שבה גדל הנסיך סידהרתא לפני שיצא למסעו. מה שנשאר הוא יסודות לבנים, שערי עיר ותלוליות בתוך חורשה שקטה, בלי מבנים שלמים. האתר כמעט ריק ממבקרים ומי שמחפש חוויה ויזואלית יתאכזב, אבל למי שמכיר את הסיפור זה מקום מהורהר במיוחד. נמצא כשעה נסיעה מערבית ללומביני.',
        rating: 4.0,
        durationMin: 90,
        tags: ['history'],
        priceLevel: 1,
        externalUrl: 'https://maps.google.com/?q=27.57999992370605,83.08000183105469',
      },
      {
        id: 'np-bardiya',
        name: 'Bardiya National Park',
        nameLocal: 'הפארק הלאומי ברדייה',
        category: 'nature',
        lat: 28.38333320617676,
        lng: 81.5,
        description:
          'השמורה הגדולה ביותר בטראי המערבי, פראית ומרוחקת הרבה יותר מצ׳יטוואן ועם הרבה פחות מבקרים. יערות סאל ושטחי דשא לאורך נהר קרנאלי, עם קרנפים חד-קרניים, פילי בר, תנינים וגם אוכלוסיית נמרים. סיורי הליכה עם מדריך ותצפיות ארוכות מגדות הנהר הם הדרך המקובלת. תצפית על נמר היא עניין של מזל גדול ורוב המבקרים לא רואים אחד.',
        rating: 4.5,
        durationMin: 480,
        tags: ['outdoors'],
        priceLevel: 2,
        mustSee: true,
        externalUrl: 'https://maps.google.com/?q=28.38333320617676,81.5',
      },
      {
        id: 'np-nepalgunj',
        name: 'Nepalgunj',
        nameLocal: 'נפאלגונג׳',
        category: 'attraction',
        lat: 28.04999923706055,
        lng: 81.61666870117188,
        description:
          'העיר הגדולה של הטראי המערבי ונקודת הכניסה האווירית לאזור, עם טיסות פנים מקטמנדו. עיר סוחרת חמה ורועשת ממש על הגבול ההודי, עם שווקים צפופים, אוכלוסייה מוסלמית גדולה ואווירה שהיא כבר חצי הודית. אין כאן אתרים תיירותיים של ממש, אבל זו העצירה הלוגיסטית המתבקשת בדרך לברדייה ומקום טוב לראות את הטראי כפי שהוא באמת.',
        rating: 3.6,
        durationMin: 120,
        tags: ['foodie'],
        priceLevel: 1,
        externalUrl: 'https://maps.google.com/?q=28.04999923706055,81.61666870117188',
      },
      {
        id: 'np-tansen',
        name: 'Tansen',
        nameLocal: 'טנסן',
        category: 'viewpoint',
        lat: 27.86666679382324,
        lng: 83.55000305175781,
        description:
          'עיירת גבעות נווארית ישנה שיושבת מעל המישור, בערך שעתיים צפונית ללומביני. סמטאות מרוצפות, בתי לבנים אדומות, ארמון טנסן דורבר ומסורת מקומית של אריגת בדים ועבודות מתכת. בימים בהירים בחורף אפשר לראות מכאן קו הימלאיה רחוק, אבל זה לא מובטח כלל. עצירה נעימה לאוויר קריר אחרי החום של המישור.',
        rating: 4.0,
        durationMin: 180,
        tags: ['history'],
        priceLevel: 1,
        externalUrl: 'https://maps.google.com/?q=27.86666679382324,83.55000305175781',
      },
      {
        id: 'np-janakpur',
        name: 'Janakpur',
        ...
        description:
          'העיר הקדושה של המישור המזרחי, שלפי הרמאיאנה היא מקום הולדתה של סיטה ומקום נישואיה לראמה. במרכז עומד מקדש ג׳אנקי, מבנה ורוד גדול בסגנון מוגולי-ראג׳פוטי מתחילת המאה ה-20, שסביבו בריכות טקס ושוק סואן. האזור מיתילי בתרבותו וידוע באמנות הקיר הצבעונית שלו. צפוף מאוד בחגים.',
        rating: 4.2,
        durationMin: 180,
        tags: ['history'],
        priceLevel: 1,
        externalUrl: 'https://maps.google.com/?q=26.72861099243164,85.92500305175781',
      },
      {
        id: 'np-koshi-tappu',
        name: 'Koshi Tappu Wildlife Reserve',
        nameLocal: 'שמורת קושי טאפו',
        category: 'nature',
        lat: 26.64999961853027,
        lng: 87.0,
        description:
          'שמורת ביצות ושטחי מים לאורך נהר קושי בקצה המזרחי של הטראי, אתר רמסאר ואחד ממוקדי צפרות הטובים בדרום אסיה. כאן שורדת אוכלוסיית הבופלו הפראי האחרונה בנפאל, ובחורף מגיעים לכאן מאות מיני ציפורים נודדות. הנוף פתוח ומימי ולא יער, וההתמצאות דורשת מדריך מקומי וסירה. תשתית הלינה בסיסית מאוד.',
        rating: 4.1,
        durationMin: 300,
        tags: ['outdoors'],
        priceLevel: 1,
    ...
    itinerary: [
      ...
      {
        day: 3,
        title: 'מערבה: נפאלגונג׳ וברדייה',
        placeIds: ['np-nepalgunj', 'np-bardiya'],
        notes: 'נסיעה ארוכה על כביש מהנדרה, או טיסה פנימית דרך נפאלגונג׳ כדי לחסוך יום.',
      },
      {
        day: 4,
        title: 'ספארי בברדייה',
        placeIds: ['np-bardiya'],
        notes: 'יום שלם עם מדריך: הליכה ביער ותצפית ארוכה על גדות הקרנאלי.',
      },
      {
        day: 5,
        title: 'המישור המזרחי: ג׳נקפור',
        placeIds: ['np-janakpur'],
        notes: 'מעבר ארוך מאוד מזרחה. עדיף לשלב טיסה פנימית ולא לנסוע את כל המישור ביום אחד.',
      },
      {
        day: 6,
        title: 'ציפורים בקושי טאפו',
        placeIds: ['np-koshi-tappu'],
        notes: 'יציאה בשחר עם מדריך מקומי וסירה. משקפת חיונית.',
      },
    ],
    practical: {
      flights:
        'טיסות לקטמנדו דרך חיבור באיסטנבול, דובאי, אבו דאבי או דוחא. מקטמנדו יש טיסות פנים קצרות לבהיראהאווה (ליד לומביני), לנפאלגונג׳ ולביראטנגר (ליד קושי טאפו), והן חוסכות ימי נסיעה שלמים. לחלופין נסיעה יבשתית ארוכה מאוד מקטמנדו, שבע עד עשר שעות ללומביני.',
      gettingAround:
        'הדרך המעשית היא רכב עם נהג מקומי, כי המרחקים גדולים והנהיגה העצמאית קשה. אוטובוסים ציבוריים זולים מאוד אך איטיים וצפופים. בתוך הערים ריקשות ואופנועים. בעונת המונסון חלק מהדרכים נחסמות והלוחות זמנים משתנים.',
      kosherOverview:
        'אין שום מסעדה או חנות כשרה במישור הטראי. הנוכחות היהודית היחידה בנפאל היא בקטמנדו, שם פועל בית חב״ד ומתקיים סדר פסח גדול, וכדאי לתאם מולו מראש אספקה לפני היציאה לטראי. המטבח המקומי מבוסס על דאל בהאט (עדשים, אורז וירקות) ועל צ׳אפאטי, ולצמחונים המצב נוח יחסית כי חלק גדול מהאוכלוסייה ההינדית צמחוני ובקר אינו נאכל. עם זאת מוגשים גם עוף, עז ובאזורים מסוימים בשר בופלו, וכלי הבישול משותפים. יש לוודא בטלפון מול חב״ד קטמנדו לפני הנסיעה, ולא להסתמך על שום מידע כתוב.',
    },
  },
  {
    slug: 'zanzibar-swahili-coast',
    name: 'Zanzibar and the Swahili Coast',
    nameLocal: 'זנזיבר וחוף הסוואהילי',
    countrySlug: 'tanzania',
    flag: '🇹🇿',
    center: { lat: -6.3, lng: 39.3 },
    zoom: 7,
    tagline: 'תבלינים, אבן אלמוגים ומים תכולים: פנים אחרות לגמרי של טנזניה, אחרי הספארי',
    editorialRating: {
      score: 8.1,
      verdict:
        'זנזיבר יפה, אבל היא לא גן עדן פרטי כפי שהתמונות מבטיחות. הגאות והשפל בחוף המזרחי דרמטיים: פעמיים ביום הים נסוג מאות מטרים ואי אפשר לשחות, וזה מפתיע רבים שלא בדקו לוח גאות לפני שהזמינו. אבן סטון טאון יפהפייה אבל גם מוזנחת, מלוכלכת בחלקים ומלאה ב״פאפאסי״, סוחרים אגרסיביים שנצמדים למבקרים. החום והלחות כבדים כל השנה ובעונת הגשמים הארוכה (מרץ-מאי) חלק מבתי המלון פשוט סוגרים. זו חברה מוסלמית שמרנית: מחוץ לחופי הריזורטים נדרש לבוש צנוע, ובחודש רמדאן חלק מהמסעדות סגורות ביום. הדרכים באי צרות ובמצב בינוני והנסיעה מהעיר לחוף המזרחי לוקחת יותר ממה שנראה על המפה. אין כאן חיות בר מלבד קופי קולובוס ביוזאני, אז מי שמצפה להמשך של הספארי יתאכזב. מנגד, המים באמת בצבע שלא נראה כמעט בשום מקום, הצלילה והשנרקלינג מצוינים, וההיסטוריה הסוואהילית-עומאנית-הודית של האזור יוצאת דופן.',
    },
    summary:
    ...
    bestSeason: 'יוני עד אוקטובר הם החודשים הטובים ביותר: יבשים, פחות לחים וים רגוע. דצמבר-פברואר חמים וטובים גם הם. מרץ עד מאי היא עונת הגשמים הארוכה, עם סגירות והפרעות. נובמבר גשמים קצרים.',
    places: [
      {
        id: 'tz-stone-town',
        name: 'Stone Town',
        ...
        priceLevel: 1,
        mustSee: true,
        externalUrl: 'https://maps.google.com/?q=-6.162399768829346,39.19129943847656',
      },
      {
        id: 'tz-changuu',
        name: 'Changuu Island',
        nameLocal: 'האי צ׳אנגו',
        category: 'nature',
        lat: -6.119166851043701,
        lng: 39.16666793823242,
        description:
        ...
        tags: ['families'],
        priceLevel: 1,
        externalUrl: 'https://maps.google.com/?q=-6.119166851043701,39.16666793823242',
      },
      {
        id: 'tz-jozani',
        name: 'Jozani Chwaka Bay National Park',
        nameLocal: 'הפארק הלאומי יוזאני',
        category: 'nature',
        lat: -6.266666889190674,
        lng: 39.41666793823242,
        description:
        ...
        tags: ['families', 'outdoors'],
        priceLevel: 1,
        externalUrl: 'https://maps.google.com/?q=-6.266666889190674,39.41666793823242',
      },
      {
        id: 'tz-nungwi',
        name: 'Nungwi',
        nameLocal: 'נונגווי',
        category: 'nature',
        lat: -5.72599983215332,
        lng: 39.29600143432617,
        description:
        ...
        priceLevel: 2,
        mustSee: true,
        externalUrl: 'https://maps.google.com/?q=-5.72599983215332,39.29600143432617',
      },
      {
        id: 'tz-pemba',
        name: 'Pemba Island',
        nameLocal: 'האי פמבה',
        category: 'nature',
        lat: -5.166666507720947,
        lng: 39.78333282470703,
        description:
        ...
        tags: ['outdoors', 'romantic'],
        priceLevel: 2,
        externalUrl: 'https://maps.google.com/?q=-5.166666507720947,39.78333282470703',
      },
      {
        id: 'tz-bagamoyo',
        name: 'Bagamoyo',
        ...
        tags: ['history'],
        priceLevel: 1,
        externalUrl: 'https://maps.google.com/?q=-6.44444465637207,38.90277862548828',
      },
      {
        id: 'tz-kilwa-kisiwani',
        name: 'Kilwa Kisiwani',
        nameLocal: 'קילווה קיסיוואני',
        category: 'attraction',
        ...
        tags: ['history'],
        priceLevel: 1,
        externalUrl: 'https://maps.google.com/?q=-8.960000038146973,39.51279830932617',
      },
    ],
    itinerary: [
      {
      ...
      },
      {
        ...
        title: 'פמבה',
        placeIds: ['tz-pemba'],
        notes: 'טיסה קצרה מזנזיבר. לצוללים כדאי לתכנן כאן לפחות שני לילות.',
      },
      {
        day: 5,
      ...
      },
      {
        day: 6,
        title: 'דרומה לקילווה',
        placeIds: ['tz-kilwa-kisiwani'],
        notes: 'יום ארוך מאוד. עדיף לינה בקילווה מסוקו ולתאם סירה ואישור ביקור מראש.',
      },
    ],
    practical: {
      flights:
  ...
  },
  {
    ...
    nameLocal: 'בורנאו המלזית',
    countrySlug: 'malaysia',
    flag: '🇲🇾',
    center: { lat: 4.0, lng: 115.5 },
    zoom: 6,
    tagline: 'אורנגאוטנים, מערות ענק ואחד אתרי הצלילה הטובים בעולם, בחצי המזרחי של מלזיה',
    editorialRating: {
      score: 8.6,
      verdict:
        'בורנאו היא החלק היקר, הלוגיסטי והמתיש של מלזיה, ומי שמצפה להמשך של קואלה לומפור או פנאנג יופתע. המרחקים עצומים ובין סבאח לסראוואק חייבים לטוס, וגם בתוך כל מדינה הנסיעות ארוכות. מולו נגישה רק בטיסה, סיפאדן דורשת אישור צלילה במכסה יומית מוגבלת שנתפסת חודשים מראש ואי אפשר ללון על האי, ודנום ולודג׳ים בקינבטנגן יקרים משמעותית מרמת המחירים של שאר מלזיה. האקלים לח וחם כל השנה ויורדים גשמים גם ב״עונה היבשה״, יש עלוקות בשבילי היער ובעונות מסוימות יתושים רבים. תצפיות חיות בר לעולם אינן מובטחות: אורנגאוטן בר הוא עניין של מזל, וגם בספילוק ההאכלה לא תמיד מביאה קופים. חלק גדול מיערות השפלה הוסבו למטעי דקלי שמן, ובנסיעה רואים קילומטרים על קילומטרים של מונוקולטורה שקצת שוברת את האשליה. מנגד, מי שמוכן לשלם ולסבול את הלחות מקבל אחד המקומות המגוונים ביולוגית בעולם, ומערות מולו ואתרי הצלילה בסלבס הם ברמה עולמית ממש.',
    },
    summary:
      'החצי המזרחי של מלזיה יושב על האי בורנאו ומורכב משתי מדינות, סבאח בצפון וסראוואק בדרום-מערב, והוא כמעט מדינה אחרת. במקום ערי מיצרים סיניות-מלאיות יש כאן יער גשם עתיק, נהרות חומים, שבטי דייק, ההר הגבוה בדרום-מזרח אסיה, מערכות מערות מהגדולות בעולם ושונית אלמוגים בקצה משולש האלמוגים. הנסיעה מחברת בין פארק קינבלו, מרכז האורנגאוטנים בספילוק, שיט על נהר קינבטנגן, הצלילה בסיפאדן, מערות גונונג מולו והיער החופי בבאקו.',
    bestSeason: 'מרץ עד אוקטובר הם החודשים היבשים יחסית והטובים ביותר, ובעיקר אפריל-ספטמבר לצלילה בסיפאדן כשהים רגוע והראות מרבית. נובמבר עד פברואר עונת המונסון הצפון-מזרחית, עם גשמים כבדים וביטולי סירות. חם ולח כל השנה.',
    places: [
      {
        id: 'my-kinabalu-park',
        name: 'Kinabalu Park',
        nameLocal: 'הפארק הלאומי קינבלו',
        category: 'nature',
        lat: 6.150000095367432,
        lng: 116.6500015258789,
        description:
          'אתר המורשת העולמית הראשון של מלזיה, סביב הר קינבלו שמתנשא לגובה של יותר מארבעת אלפים מטר. הפארק מכסה טווח אקלימי שלם מיער גשם ועד צמחייה אלפינית, וידוע בריכוז יוצא דופן של סחלבים וצמחי כד טורפים. הטיפוס לפסגה הוא מסלול דו-יומי עם לינה בהר, במכסה מוגבלת שמתמלאת מראש ובליווי מדריך חובה. מי שלא מטפס יכול להסתפק בשבילים ובגן הבוטני שלמרגלות ההר.',
        rating: 4.7,
        durationMin: 360,
        tags: ['outdoors'],
        priceLevel: 2,
        mustSee: true,
        externalUrl: 'https://maps.google.com/?q=6.150000095367432,116.6500015258789',
      },
      {
        id: 'my-sepilok',
        name: 'Sepilok Orangutan Rehabilitation Centre',
        nameLocal: 'מרכז השיקום לאורנגאוטנים בספילוק',
        category: 'nature',
        lat: 5.865009784698486,
        lng: 117.9493865966797,
        description:
          'המרכז הוותיק בעולם לשיקום אורנגאוטנים יתומים, פועל מ-1964 בשולי שמורת יער קאבילי. הקופים חיים חופשי ביער ומגיעים לשתי האכלות יומיות על פלטפורמת עץ, כשמסלול עץ מוגבה מוביל אליה. חשוב לדעת שאם היער נותן פרי הקופים פשוט לא מגיעים. בסמוך פועל מרכז לדוב השמש הבורנאי, וכדאי לשלב את השניים.',
        rating: 4.6,
        durationMin: 180,
        tags: ['families', 'outdoors'],
        priceLevel: 1,
        mustSee: true,
        externalUrl: 'https://maps.google.com/?q=5.865009784698486,117.9493865966797',
      },
      {
        id: 'my-kinabatangan',
        name: 'Kinabatangan River',
        nameLocal: 'נהר קינבטנגן',
        category: 'nature',
        lat: 5.626138687133789,
        lng: 118.5726089477539,
        description:
          'הנהר הארוך בסבאח, ורצועת היער שנותרה לשני צידיו הפכה למסדרון שבו מרוכזות חיות בר במיוחד, בדיוק משום שהיער סביב נכרת למטעים. שייט בסירה בשחר ובשקיעה מאפשר לראות קופי חדק, מקוקים, פילים ננסיים בורנאיים בעונות מסוימות, תנינים ולהקות קלאו. הלינה היא בלודג׳ים על גדות הנהר, ברמות שונות ובמחירים גבוהים יחסית.',
        rating: 4.6,
        durationMin: 480,
        tags: ['outdoors'],
        priceLevel: 2,
        mustSee: true,
        externalUrl: 'https://maps.google.com/?q=5.626138687133789,118.5726089477539',
      },
      {
        id: 'my-sipadan',
        name: 'Sipadan',
        nameLocal: 'סיפאדן',
        category: 'nature',
        lat: 4.114683151245117,
        lng: 118.6287536621094,
        description:
          'אי אלמוגים קטן שיושב על צוק תת-ימי היורד למאות מטרים, ונחשב לאחד אתרי הצלילה הטובים בעולם. להקות ברקודה ענקיות, צבי ים בכל צלילה וכרישי שונית. מספר הצוללים מוגבל לכמה עשרות אישורים ליום שמחולקים דרך אתרי הצלילה בלבד, ואין אפשרות ללון על האי עצמו - הלינה במאבול או בסמפורנה. יש לתכנן חודשים מראש.',
        rating: 4.9,
        durationMin: 480,
        tags: ['outdoors'],
        priceLevel: 3,
        mustSee: true,
        externalUrl: 'https://maps.google.com/?q=4.114683151245117,118.6287536621094',
      },
      {
        id: 'my-mulu',
        name: 'Gunung Mulu National Park',
        nameLocal: 'הפארק הלאומי גונונג מולו',
        category: 'nature',
        lat: 4.042500019073486,
        lng: 114.8125,
        description:
          'אתר מורשת עולמית בסראוואק ואחת ממערכות המערות המרשימות בעולם. אולם סראוואק הוא מהחללים התת-קרקעיים הגדולים ביותר שנמדדו, ובמערת האבד יוצאים מדי ערב מיליוני עטלפים בנחיל מסתחרר. יש גם מסלול על גשרי חבלים בחופת היער ואת פסגות האבן המחודדות של הפינקלס למטיילים מנוסים. ההגעה בטיסה קטנה בלבד, אין כביש.',
        rating: 4.8,
        durationMin: 600,
        tags: ['outdoors'],
        priceLevel: 2,
        mustSee: true,
        externalUrl: 'https://maps.google.com/?q=4.042500019073486,114.8125',
      },
      {
        id: 'my-bako',
        name: 'Bako National Park',
        nameLocal: 'הפארק הלאומי באקו',
        category: 'nature',
        lat: 1.716666698455811,
        lng: 110.466667175293,
        description:
          'הפארק הלאומי הוותיק בסראוואק, על חצי אי סלעי שאליו מגיעים רק בסירה מכפר באקו. שילוב נדיר של צוקי אבן חול אדומים, חופים מבודדים, ביצות ויער כד טורף, ועם סיכוי טוב במיוחד לראות קופי חדק ומקוקים חצופים ליד המזח. רשת שבילים בדרגות שונות, מהליכה קצרה ועד יום שלם. הלינה בפארק בסיסית מאוד ומוזמנת מראש.',
        rating: 4.5,
        durationMin: 420,
        tags: ['outdoors'],
        priceLevel: 1,
        externalUrl: 'https://maps.google.com/?q=1.716666698455811,110.466667175293',
      },
    ],
    itinerary: [
      {
      ...
      {
        day: 3,
        title: 'שיט על קינבטנגן',
        placeIds: ['my-kinabatangan'],
        notes: 'לינה בלודג׳ על הנהר. שני שייטים, בשחר ובשקיעה, הם הזמן הטוב לתצפיות.',
      },
      {
        day: 4,
        title: 'צלילה בסיפאדן',
    ...
    practical: {
      flights:
        'טיסות לקואלה לומפור דרך חיבור באיסטנבול, דובאי, אבו דאבי או דוחא, ומשם טיסת פנים של כשעתיים וחצי לקוטה קינבלו (סבאח) או לקוצ׳ינג (סראוואק). יש גם חיבורים דרך סינגפור. שימו לב שסבאח וסראוואק מפעילות בקרת כניסה משלהן וחותמות דרכון גם בטיסה פנימית ממלזיה היבשתית.',
      gettingAround:
        'בין סבאח לסראוואק טסים, אין דרך יבשתית מעשית. בתוך סבאח הדרך הנוחה היא רכב שכור או נהג מקומי, והכביש קוטה קינבלו-סנדקאן לוקח כשש שעות. מולו נגישה בטיסה בלבד. לסיפאדן ולבאקו מגיעים בסירה בלבד. מומלץ להזמין טיסות פנים ולודג׳ים הרבה מראש, במיוחד בעונה היבשה.',
      kosherOverview:
        'אין שום מסעדה או חנות כשרה בבורנאו המלזית, וגם לא בקואלה לומפור. אין קהילה יהודית מאורגנת במלזיה, ואין נציגות ישראלית במדינה. הקהילה והמסעדות הכשרות הקרובות ביותר נמצאות בסינגפור, כשעתיים וחצי טיסה, וכדאי להצטייד שם או מהארץ. מלזיה מוסלמית ברובה ולכן רוב המסעדות חלאל וחזיר נדיר, אבל זה לא אומר כשר: הבשר אינו כשר, וכלי הבישול משותפים. בבורנאו דווקא כן נפוץ חזיר במטבחים סיניים ובכפרים הלא-מוסלמיים, ויש להיזהר במיוחד. הבסיס הצמחוני והטבעוני סביר - אורז, נודלס, ירקות, פירות טרופיים - אך רוטב דגים ומשחת שרימפס נפוצים מאוד גם במנות שנראות צמחוניות. יש לוודא כל פרט בטלפון מראש ולא להסתמך על מידע כתוב.',
    },
  },
  {
    slug: 'bali-lesser-sunda',
    name: 'Bali and the Lesser Sunda Islands',
    nameLocal: 'באלי ואיי סונדה הקטנים',
    countrySlug: 'indonesia',
    flag: '🇮🇩',
    center: { lat: -8.5, lng: 116.5 },
    zoom: 7,
    tagline: 'מקדשים על צוקים, הרי געש בשחר ודרקוני קומודו: האי ההינדי של אינדונזיה והשכנים שלו',
    editorialRating: {
      score: 8.3,
      verdict:
        'באלי היא אחד היעדים המפורסמים בעולם, ובדיוק בגלל זה היא גם אחד המאכזבים אם מגיעים אליה עם ציפיות מאינסטגרם. הדרום - קוטה, סמיניאק, צ׳אנגו - סובל מפקקים קשים באמת, שבהם עשרה קילומטרים לוקחים שעה, ומצפיפות בנייה שלא נעצרת. אובוד כבר מזמן אינה כפר אמנים שקט אלא עיירה עמוסת חנויות, בתי קפה ותנועה. באתרים המפורסמים כמו טאנה לוט ואולוואטו יש המוני מבקרים בשעת השקיעה ותורים ארוכים, ובבסאקי הופעלו במשך שנים לחצי ״מדריך חובה״ ותרומות מנופחות על תיירים, נושא שיש להיערך אליו מראש. הטיפוס לבאטור בשחר הפך למסלול תעשייתי עם מאות אנשים בטור. יש גם בעיית פסולת פלסטיק על חופי המערב בעונת הגשמים. ולבסוף, קומודו ורינג׳אני אינם ״טיול צד״ מבאלי אלא יעדים בפני עצמם שדורשים טיסה ולילות נוספים. מנגד, התרבות ההינדו-באלינזית חיה ואמיתית לגמרי ולא הצגה לתיירים, הנוף הפנימי של מדרגות אורז והרי געש מרהיב, המחירים עדיין נמוכים ורמת האירוח גבוהה מאוד ביחס למחיר.',
    },
    summary:
    ...
    bestSeason: 'אפריל עד אוקטובר היא העונה היבשה והטובה ביותר, ובעיקר מאי-יוני וספטמבר כשהמחירים נמוכים יותר מיולי-אוגוסט. נובמבר עד מרץ עונת גשמים עם ממטרים כבדים אחר הצהריים, ים סוער ופחות ימי צלילה. הטמפרטורה גבוהה ויציבה כל השנה.',
    places: [
      {
        id: 'id-tanah-lot',
        name: 'Tanah Lot',
        ...
        priceLevel: 1,
        mustSee: true,
        externalUrl: 'https://maps.google.com/?q=-8.62106990814209,115.087158203125',
      },
      {
        id: 'id-uluwatu',
        name: 'Uluwatu Temple',
        nameLocal: 'מקדש אולוואטו',
        category: 'attraction',
        ...
        priceLevel: 1,
        mustSee: true,
        externalUrl: 'https://maps.google.com/?q=-8.828888893127441,115.0852813720703',
      },
      {
        id: 'id-goa-gajah',
        name: 'Goa Gajah',
        nameLocal: 'גואה גאג׳ה',
        category: 'attraction',
        ...
        tags: ['history'],
        priceLevel: 1,
        externalUrl: 'https://maps.google.com/?q=-8.523388862609863,115.2863616943359',
      },
      {
        id: 'id-batur',
        name: 'Mount Batur',
        nameLocal: 'הר הגעש באטור',
        category: 'viewpoint',
        lat: -8.238888740539551,
        lng: 115.3775024414062,
        description:
        ...
        tags: ['outdoors'],
        priceLevel: 1,
        externalUrl: 'https://maps.google.com/?q=-8.238888740539551,115.3775024414062',
      },
      {
        id: 'id-besakih',
        name: 'Besakih Temple',
        nameLocal: 'מקדש בסאקי',
        category: 'attraction',
        ...
        tags: ['history'],
        priceLevel: 1,
        externalUrl: 'https://maps.google.com/?q=-8.374367713928223,115.4509353637695',
      },
      {
        id: 'id-rinjani',
        name: 'Mount Rinjani',
        nameLocal: 'הר הגעש רינג׳אני',
        category: 'nature',
        lat: -8.414414405822754,
        lng: 116.4597702026367,
        description:
        ...
        tags: ['outdoors'],
        priceLevel: 2,
        externalUrl: 'https://maps.google.com/?q=-8.414414405822754,116.4597702026367',
      },
      {
        id: 'id-komodo',
        name: 'Komodo National Park',
        nameLocal: 'הפארק הלאומי קומודו',
        category: 'nature',
        lat: -8.543333053588867,
        lng: 119.4894409179688,
        description:
        ...
        priceLevel: 2,
        mustSee: true,
        externalUrl: 'https://maps.google.com/?q=-8.543333053588867,119.4894409179688',
      },
    ],
    itinerary: [
      {
      ...
      },
      {
        ...
        title: 'דרקוני קומודו',
        placeIds: ['id-komodo'],
        notes: 'טיסה ללבואן באג׳ו ומשם סירה. עדיף לילה אחד לפחות בעיר הנמל.',
      },
    ],
    practical: {
      flights:
  ...
  {
    slug: 'western-serbia',
    name: 'Western Serbia and the Raska Valley',
    nameLocal: 'מערב סרביה ועמק ראשקה',
    countrySlug: 'serbia',
    flag: '🇷🇸',
    center: { lat: 43.55, lng: 20.0 },
    zoom: 8,
    tagline: 'רכבת צרה בהרים, כפרי עץ ומנזרים מהמאה ה-12: הצד הכפרי והשקט של סרביה',
    editorialRating: {
      score: 8.0,
      verdict:
        'זה אזור לאוהבי נוף כפרי ומנזרים, לא למחפשי אטרקציות. אין כאן ערים יפות: אוז׳יצה ונובי פזאר הן ערי תעשייה סוציאליסטיות אפורות ברובן, ורוב הלינה היא בפנסיונים כפריים ברמה משתנה. המרחקים על המפה מטעים: הכבישים ההרריים מפותלים וצרים ומאה קילומטרים לוקחים לעיתים שעתיים וחצי, וחלק מהגישות למנזרים הן דרכי חצץ. הרכבת הצרה בשארגן היא נסיעה תיירותית מבוימת של שעתיים וחצי שחלק מהאנשים אוהבים מאוד וחלק משתעממים בה. שמורת אובאץ דורשת סירה עם מפעיל מקומי ותיאום מראש, ובימים מעוננים התצפית על הפיתולים מאבדת הרבה. השילוט באנגלית דליל, במנזרים הפעילים יש קוד לבוש מחמיר ולעיתים איסור צילום, ובאזור נובי פזאר האוכלוסייה בעיקרה בושנייקית-מוסלמית והאווירה שונה לגמרי משאר סרביה, מה שמעניין אבל מפתיע חלק מהמבקרים. מנגד, המחירים מהנמוכים באירופה, האוכל טוב ומשביע, כמעט אין תיירים זרים, והאירוח הכפרי חם באמת.',
    },
    summary:
      'רוב הנוסעים לסרביה רואים את בלגרד או את מישור ווייוודינה בצפון. מערב המדינה הוא עולם אחר: רכסי יער וסיד, נהרות שחתכו קניונים עמוקים, כפרי עץ שנשמרו כפי שהיו לפני מאה שנה, וקבוצת המנזרים התזזיתית של ימי הביניים הסרביים שחלקם אתרי מורשת עולמית. הנסיעה מחברת את הרכבת הצרה של שארגן, את רמת זלאטיבור, את מוזיאון הכפר בסירוגוינו, את פיתולי אובאץ עם הנשרים, ואת שני המנזרים הגדולים סטודניצה וסופוצ׳אני בעמק ראשקה שבו נולדה מדינת סרביה.',
    bestSeason: 'מאי עד אוקטובר. יוני וספטמבר הם הטובים ביותר, עם מזג אוויר נוח, ירק ומעט מבקרים. יולי-אוגוסט חמים ומלאים בנופשים מקומיים בזלאטיבור. בחורף האזור הופך לאתר סקי מקומי, אבל דרכי הגישה למנזרים עלולות להיחסם בשלג.',
    places: [
      {
        id: 'rs-mokra-gora',
        name: 'Mokra Gora',
        nameLocal: 'מוקרה גורה',
        category: 'attraction',
        lat: 43.79247665405273,
        lng: 19.50693321228027,
        description:
          'כפר הררי סמוך לגבול הבוסני, ותחנת המוצא של רכבת שארגן שמונה - קו צר היסטורי שמטפס במעלה ההר בלולאה בצורת הספרה שמונה, עם עשרות מנהרות וגשרים. הנסיעה נמשכת כשעתיים וחצי ומיועדת כולה לתיירים. בסמוך נמצא דרוונגראד, כפר העץ שבנה הבמאי אמיר קוסטוריצה כתפאורה שהפכה לכפר אמיתי עם בתי קפה וקולנוע.',
        rating: 4.3,
        durationMin: 240,
        tags: ['families'],
        priceLevel: 1,
        mustSee: true,
        externalUrl: 'https://maps.google.com/?q=43.79247665405273,19.50693321228027',
      },
      {
        id: 'rs-zlatibor',
        name: 'Zlatibor',
        nameLocal: 'זלאטיבור',
        category: 'nature',
        lat: 43.64833450317383,
        lng: 19.67916679382324,
        description:
          'רמה הררית בגובה כאלף מטר שהיא אתר הנופש הפנימי הפופולרי ביותר בסרביה, מאז שבסוף המאה ה-19 המלך מילן הפך אותה למקום מרפא. אוויר צלול, יערות אורן, שבילי הליכה ורכיבה, ורכבל ארוך במיוחד שנפתח בשנים האחרונות. המרכז עצמו בנוי בצפיפות ומלא בבתי נופש, ומי שמחפש שקט צריך ללון בכפרים שסביב.',
        rating: 4.1,
        durationMin: 300,
        tags: ['outdoors', 'families'],
        priceLevel: 1,
        externalUrl: 'https://maps.google.com/?q=43.64833450317383,19.67916679382324',
      },
      {
        id: 'rs-sirogojno',
        name: 'Sirogojno',
        nameLocal: 'סירוגוינו',
        category: 'museum',
        lat: 43.68611145019531,
        lng: 19.87972259521484,
        description:
          'מוזיאון פתוח בשם ״הכפר הישן״, שאליו הועברו ושוחזרו בתי עץ, אסמים ומחסני מזון אותנטיים מכפרי זלאטיבור מהמאה ה-19. בניגוד למוזיאוני כפר רבים, המבנים כאן עומדים בסביבתם הטבעית על מדרון ההר וזה עושה הבדל גדול. יש סדנאות אומנות מסורתית ובית קפה. הכפר ידוע גם בסריגי הצמר המקומיים.',
        rating: 4.4,
        durationMin: 150,
        tags: ['history', 'families'],
        priceLevel: 1,
        externalUrl: 'https://maps.google.com/?q=43.68611145019531,19.87972259521484',
      },
      {
        id: 'rs-uvac',
        name: 'Uvac',
        nameLocal: 'שמורת אובאץ',
        category: 'viewpoint',
        lat: 43.34944534301758,
        lng: 19.97027778625488,
        description:
          'שמורת טבע מיוחדת סביב נהר אובאץ, שיצר בקניון סדרת פיתולים חדים שנראים מלמעלה כמו נחש כחול בין הצוקים. כאן חיה אחת האוכלוסיות הגדולות באירופה של נשר מקראי, שכמעט נכחד באזור והוחזר במאמץ שימור. הביקור הרגיל הוא סירה בנהר בתוספת טיפוס למצפה, וגם מערת אובאץ פתוחה לסיור. יש לתאם סירה מראש.',
        rating: 4.6,
        durationMin: 300,
        tags: ['outdoors'],
        priceLevel: 1,
        mustSee: true,
        externalUrl: 'https://maps.google.com/?q=43.34944534301758,19.97027778625488',
      },
      {
        id: 'rs-studenica',
        name: 'Studenica Monastery',
        nameLocal: 'מנזר סטודניצה',
        category: 'attraction',
        lat: 43.48611068725586,
        lng: 20.53667068481445,
        description:
          'המנזר החשוב ביותר בסרביה ואתר מורשת עולמית של אונסק״ו, שהוקם בשנות ה-80 של המאה ה-12 בידי סטפן נמניה, מייסד השושלת. שתי כנסיות שיש לבן בתוך חומה עגולה, ובתוכן פרסקאות ביזנטיות מ-1209 שנחשבות מהיפות בעולם הביזנטי. המנזר פעיל, עם נזירים ומגורים, ולכן נדרש לבוש צנוע והצילום מוגבל בפנים.',
        rating: 4.8,
        durationMin: 150,
        tags: ['history', 'art'],
        priceLevel: 0,
        mustSee: true,
        externalUrl: 'https://maps.google.com/?q=43.48611068725586,20.53667068481445',
      },
      {
        id: 'rs-sopocani',
        name: 'Sopocani Monastery',
        nameLocal: 'מנזר סופוצ׳אני',
        category: 'attraction',
        lat: 43.11805725097656,
        lng: 20.3738899230957,
        description:
          'מנזר מהמאה ה-13 ליד נובי פזאר, אתר מורשת עולמית, שידוע בעיקר בזכות פרסקו ״רדת השכינה של מרים״ שנחשב לאחת היצירות הגדולות של הציור האירופי בימי הביניים. המנזר נהרס בידי העות׳מאנים ועמד ללא גג מאות שנים, וזה שהצבעים שרדו בכלל נחשב לפלא. שקט מאוד, כמעט בלי מבקרים, ובסביבה עוד אתרים מהמאה ה-12.',
        rating: 4.7,
        durationMin: 120,
        tags: ['history', 'art'],
        priceLevel: 0,
    ...
    practical: {
      flights:
        'טיסות לבלגרד, ישירות או עם חיבור באירופה. משדה התעופה נסיעה של כשלוש שעות מערבה לזלאטיבור. אפשרות נוספת היא לנחות בסרייבו או בפודגוריצה ולהיכנס מהגבול המערבי, מסלול שמתאים למי שמשלב כמה מדינות בבלקן.',
      gettingAround:
        'רכב שכור הוא הכרחי כמעט: התחבורה הציבורית בין הכפרים והמנזרים דלילה מאוד. הכבישים סלולים ברובם אבל צרים ומפותלים, ויש קטעי חצץ בגישה לחלק מהמנזרים. לתכנן זמני נסיעה נדיבים, לא לפי המרחק על המפה. תחנות דלק זמינות בערים הראשיות אך לא בהרים, וכדאי למלא מראש.',
      kosherOverview:
        'אין מסעדה או חנות כשרה במערב סרביה. הקהילה היהודית היחידה במדינה עם תשתית פעילה נמצאת בבלגרד, שם יש בית כנסת ומרכז קהילתי, וכן פעילות חב״ד, וכדאי לתאם מולם מראש אספקה לפני היציאה מערבה. המטבח הסרבי מבוסס מאוד על חזיר ועל נקניקים מעושנים, גם במנות שלא נראות כך, ויש להיזהר במיוחד. מנגד יש בחירה רחבה של סלטים, גבינות כפריות, ירקות בגריל, פלפלים ממולאים ולחם, כך שלצמחונים המצב סביר. יש לוודא בטלפון מול הקהילה בבלגרד לפני הנסיעה, ולא להסתמך על שום מידע כתוב.',
    },
  },
  {
    slug: 'bosanska-krajina',
    name: 'Bosanska Krajina and Central Bosnia',
    nameLocal: 'בוסנסקה קראיינה ומרכז בוסניה',
    countrySlug: 'bosnia',
    flag: '🇧🇦',
    center: { lat: 44.6, lng: 16.5 },
    zoom: 8,
    tagline: 'נהר אונה הטורקיז, מצודות על צוקים ועיירת וזירים עות׳מאנית, בצפון-מערב שאף אחד לא מגיע אליו',
    editorialRating: {
      score: 7.6,
      verdict:
        'זה אזור למי שכבר ראה את מוסטאר וסרייבו ורוצה בוסניה בלי אוטובוסי תיירים, ולא ליעד ראשון במדינה. אין כאן אתר אחד גדול שמצדיק לבדו את הנסיעה: הכוח הוא בהצטברות של נהר, מצודות ועיירות קטנות. התשתית התיירותית בסיסית ולעיתים כמעט לא קיימת, השילוט באנגלית דל, ובחלק מהמקומות פשוט אין מי שיסביר מה רואים. פצעי המלחמה של שנות ה-90 גלויים מאוד באזור הזה: בתים הרוסים שנשארו כך, כפרים שהתרוקנו ולא התאוששו, וערים שההרכב האתני שלהן השתנה לחלוטין. יש עדיין אזורים עם סימון סכנת מוקשים, וחובה לא לצאת משבילים מסומנים בשום מצב. הכבישים בין העמקים מפותלים ואיטיים, והמעבר בין הפדרציה לרפובליקה הסרפסקה מורגש בשלטים, במטבע היומיומי ובאווירה. מנגד, אונה הוא אחד הנהרות היפים באירופה באמת, הרפטינג בו מצוין, המחירים נמוכים מאוד והאירוח המקומי חם ונדיב.',
    },
    summary:
      'הצפון-מערב של בוסניה, המחוז שנקרא קראיינה, הוא אזור של נהרות קרסטיים בצבע טורקיז, מפלי מדרגות, מצודות עות׳מאניות ואוסטרו-הונגריות שיושבות מעל כפיפות הנהר, ויערות אשור עבותים. ממזרח לו נמצאת בוסניה התיכונה עם טרווניק, עיר הוזירים העות׳מאנים ומקום הולדתו של איוו אנדריץ׳ חתן פרס נובל. הנסיעה מחברת את הפארק הלאומי אונה, את מצודת אוסטרוז׳אץ, את הפארק הלאומי קוזארה, ואת העיירות שלאורך הדרך. זו נסיעה איטית, כפרית ומאוד לא מתויירת.',
    bestSeason: 'מאי עד ספטמבר. מאי-יוני הם השיא לרפטינג כשמפלס אונה גבוה והנוף ירוק במיוחד. יולי-אוגוסט חמים ונוחים לרחצה בנהר. אוקטובר יפה בצבעי סתיו ביערות קוזארה. בחורף רוב הפעילות בנהר נסגרת.',
    places: [
      {
        id: 'ba-una-park',
        name: 'Una National Park',
        nameLocal: 'הפארק הלאומי אונה',
        category: 'nature',
        lat: 44.49526596069336,
        lng: 16.13498878479004,
        description:
          'הפארק הלאומי הצעיר בבוסניה, שהוקם ב-2008 לאורך נהר אונה ויובלו אונאץ. הנהר קרסטי וצלול בצבע טורקיז, ולאורכו סדרת מפלי מדרגות רחבים, ובראשם מפל שטרבצקי בוק. זהו מרכז הרפטינג הידוע ביותר במדינה, בדרגות קושי שונות לפי הקטע ולפי מפלס המים. יש גם שבילי הליכה, גשרי עץ ומסעדות דגים על הנהר. הגישה לחלק מהאתרים בדרכי עפר.',
        rating: 4.7,
        durationMin: 360,
        tags: ['outdoors'],
        priceLevel: 1,
        mustSee: true,
        externalUrl: 'https://maps.google.com/?q=44.49526596069336,16.13498878479004',
      },
      {
        id: 'ba-ostrozac',
        name: 'Ostrozac Castle',
        nameLocal: 'מצודת אוסטרוז׳אץ',
        category: 'attraction',
        lat: 44.90399932861328,
        lng: 15.9370002746582,
        description:
          'מצודה שיושבת על צוק מעל נהר אונה, עם גרעין עות׳מאני מהמאה ה-16 ואגף ארמוני שהוסיפה משפחת אצולה אוסטרו-הונגרית בתחילת המאה ה-20. השילוב בין שתי התקופות מוזר ומרשים. בחצר ובגנים פזורים עשרות פסלי אבן שנוצרו בסימפוזיוני פיסול שהתקיימו כאן בתקופה היוגוסלבית. האתר מתוחזק חלקית ולא ממש מוסבר, וזה חלק מהקסם שלו.',
        rating: 4.3,
        durationMin: 120,
        tags: ['history'],
        priceLevel: 1,
      ...
      },
      {
        ...
        name: 'Bosanska Krupa',
        nameLocal: 'בוסנסקה קרופה',
        category: 'attraction',
        lat: 44.88333511352539,
        lng: 16.14999961853027,
        description:
          'עיירה קטנה שיושבת בדיוק במקום שבו אונה מתפצל לאיונים קטנים סביב אי מרכזי, עם גשרים, טחנות מים ותעלות. השרידים העות׳מאניים של העיר העתיקה נמצאים על הגבעה מעליה. זהו מוקד רחצה וקיאקים פופולרי בקרב מקומיים בקיץ, ומקום נוח לעצור לארוחה על שפת המים. אין כאן אתר ״חובה״, אלא אווירה.',
        rating: 4.0,
        durationMin: 120,
        tags: ['outdoors', 'foodie'],
        priceLevel: 1,
      ...
      },
      {
        ...
        nameLocal: 'הפארק הלאומי קוזארה',
        category: 'nature',
        lat: 45.00833511352539,
        lng: 16.89166641235352,
        description:
          'רכס יער נמוך ומכוסה אשור ואורן בצפון המדינה, מהפארקים הלאומיים הוותיקים ביוגוסלביה. יש בו שבילי הליכה ורכיבה, בקתות ואוויר הררי, והוא משמש בעיקר מקומיים. במרכזו עומד מונומנט אבן מודרניסטי גדול לזכר הקורבנות של קרב קוזארה במלחמת העולם השנייה, מהמוכרים בז׳אנר האנדרטאות היוגוסלביות. השילוט בשבילים בסיסי, כדאי מפה.',
        rating: 4.1,
        durationMin: 240,
        tags: ['outdoors', 'history'],
        priceLevel: 1,
        externalUrl: 'https://maps.google.com/?q=45.00833511352539,16.89166641235352',
      },
      {
        id: 'ba-prijedor',
        name: 'Prijedor',
        ...
        description:
          'עיר בגדת נהר סאנה ושער הכניסה המעשי לקוזארה, עם מרכז אוסטרו-הונגרי צנוע וטיילת נהר. חשוב לדעת שהאזור הזה היה זירה קשה במיוחד במלחמת 1992-1995 ובו פעלו מחנות מעצר, ונושא ההנצחה עדיין שנוי במחלוקת עמוקה בין הקהילות. מי שמגיע לכאן צריך לעשות זאת בהבנה של ההקשר ובכבוד, ולא כתחנת תיירות רגילה.',
        rating: 3.5,
        durationMin: 120,
        tags: ['history'],
        priceLevel: 1,
      ...
      },
      {
        ...
        description:
          'במשך כמאה וחמישים שנה הייתה טרווניק מושב הוזיר העות׳מאני של בוסניה, וזה עדיין ניכר: מצודה מימי הביניים על הגבעה, מסגד עטור ציורי קיר צבעוניים, בתי מרחץ ומצבות וזירים. כאן נולד איוו אנדריץ׳, חתן פרס נובל לספרות, ובית הולדתו הוא מוזיאון קטן. למרגלות העיר נובע מעיין פליבה עם מסעדות על המים. העיר עצמה שקטה ולא מטופחת במיוחד.',
        rating: 4.2,
        durationMin: 210,
        tags: ['history'],
        priceLevel: 1,
    ...
    practical: {
      flights:
        'הכי נוח לנחות בזאגרב שבקרואטיה, כשעתיים וחצי נסיעה לגבול הצפון-מערבי, או בסרייבו ולנסוע מערבה. יש גם שדות תעופה קטנים בבניה לוקה ובטוזלה עם חיבורים אירופיים מוגבלים. מעבר הגבול קרואטיה-בוסניה יכול לקחת זמן בעונת הקיץ, וחשוב לוודא שחברת ההשכרה מאשרת מעבר גבול בכתב.',
      gettingAround:
  ...
  {
    slug: 'northern-albania',
    name: 'Shkodra, the Albanian Alps and Kruja',
    nameLocal: 'שקודרה, האלפים האלבניים וקרויה',
    countrySlug: 'albania',
    flag: '🇦🇱',
    center: { lat: 42.1, lng: 19.6 },
    zoom: 8,
    tagline: 'הרי הארורים, אגם ענק ומצודת סקנדרבג: הצפון ההררי שאין לו שום קשר לחופי הריביירה',
    editorialRating: {
      score: 8.0,
      verdict:
        'הצפון האלבני הוא הפוך לחלוטין מחופי סרנדה, וזה בדיוק העניין - אבל צריך לדעת למה נכנסים. הכבישים להרים צרים, מפותלים וחלקם לא סלולים, והנסיעה לוואלבונה או לתת שאין דורשת רכב גבוה או הסעה מקומית, לא מכונית קטנה. חלק ניכר מהתנועה לעמקים עובר דרך המעבורת על אגם קומן, שיוצאת פעם או פעמיים ביום, מתמלאת בקיץ ומבוטלת במזג אוויר גרוע - וזה יכול להרוס יום שלם. הכפרים ההרריים מציעים כמעט רק לינת אירוח כפרית פשוטה, לרוב בלי חימום ראוי ולעיתים עם חשמל לא יציב. העונה בהרים קצרה מאוד, בערך יוני עד ספטמבר, וכל השאר סגור. שקודרה עצמה עיר מאובקת ולא מטופחת, וקרויה מוכרת בשוק המזכרות שלה שהוא במידה רבה מלכודת תיירים. מנגד, הנוף בעמקי האלפים הוא מהיפים בכל הבלקן, המחירים נמוכים מאוד, האירוח האלבני נדיב באופן יוצא דופן, וכמעט אין תיירות המונים.',
    },
    summary:
      'רוב הישראלים שמגיעים לאלבניה נוסעים לחופי הדרום. הצפון הוא מדינה אחרת: רכס ההרים שנקרא ״ההרים הארורים״ עם עמקים תלולים וכפרי אבן, אגם שקודר שהוא הגדול בבלקן ומשותף עם מונטנגרו, מצודות ונציאניות ועות׳מאניות שמשקיפות על מישור המים, וקרויה שממנה הוביל סקנדרבג את המרד בעות׳מאנים במאה ה-15. הנסיעה מחברת את מצודת רוזאפה מעל שקודרה, את חופי האגם, את עמק ואלבונה בלב האלפים, ואת קרויה ההיסטורית מדרום.',
    bestSeason: 'יוני עד ספטמבר בהרים, כשהמעברים והלינה פתוחים והמעבורת בקומן פועלת באופן קבוע. מאי ואוקטובר יפים באזור האגם ובקרויה אבל בהרים כבר קר ורטוב. בחורף חלק מהכפרים ההרריים מנותקים.',
    places: [
      {
        id: 'al-rozafa',
        name: 'Rozafa Castle',
        nameLocal: 'מצודת רוזאפה',
        category: 'attraction',
        lat: 42.04650115966797,
        lng: 19.49349975585938,
        description:
          'מצודה על גבעה סלעית מעל שקודרה, במקום שבו נפגשים שלושה נהרות ונפתח נוף אל אגם שקודר ואל ההרים. השכבות שלה מספרות את ההיסטוריה של האזור: יסודות אילירים, בנייה ונציאנית וחיזוקים עות׳מאניים, ובתוכה חורבות כנסייה שהוסבה למסגד. שמה קשור לאגדה עתיקה על אישה שהוקרבה בבניית החומה. מומלץ להגיע לקראת שקיעה.',
        rating: 4.5,
        durationMin: 120,
        tags: ['history'],
        priceLevel: 1,
        mustSee: true,
        externalUrl: 'https://maps.google.com/?q=42.04650115966797,19.49349975585938',
      },
      {
        id: 'al-lake-skadar',
        name: 'Lake Skadar',
        ...
        lng: 19.3166675567627,
        description:
          'האגם הגדול ביותר בדרום אירופה, מחולק בין אלבניה למונטנגרו ומוקף הרים. הצד האלבני שקט ופחות מפותח מהצד המונטנגרי, עם כפרי דייגים, שבילי אופניים לאורך החוף ומסעדות דגים פשוטות. האגם הוא אחד מאתרי הצפרות החשובים באירופה, ובחורף מגיעים אליו אלפי עופות מים כולל שקנאים. שיט בסירה מקומית הוא הדרך הטובה לראות אותו.',
        rating: 4.3,
        durationMin: 240,
        tags: ['outdoors'],
        priceLevel: 1,
        externalUrl: 'https://maps.google.com/?q=42.16666793823242,19.3166675567627',
      },
      {
        id: 'al-valbone',
        name: 'Valbone',
        nameLocal: 'ואלבונה',
        category: 'nature',
        lat: 42.45330047607422,
        lng: 19.8878002166748,
        description:
          'עמק הררי בלב האלפים האלבניים, מוקף פסגות סלע חדות ובתחתיתו נהר לבן ורחב אבנים. זהו קצה אחד של מסלול ההליכה המפורסם בין ואלבונה לתת, כשש שעות של חצייה מעל מעבר הררי שהפכה למסלול הידוע ביותר במדינה. הלינה בעמק היא בבתי הארחה משפחתיים, פשוטים אך חמים, ורובם פתוחים רק בקיץ. ההגעה כרוכה במעבורת אגם קומן ובנסיעה בדרך הררית.',
        rating: 4.8,
        durationMin: 480,
        tags: ['outdoors'],
        priceLevel: 1,
        mustSee: true,
        externalUrl: 'https://maps.google.com/?q=42.45330047607422,19.8878002166748',
      },
      {
        id: 'al-kruje',
        name: 'Kruje',
        ...
        description:
          'עיירה שנצמדת למדרון תלול מעל המישור, ובראשה המצודה שממנה הגן סקנדרבג על אלבניה מפני העות׳מאנים במאה ה-15. בתוך המצודה עומדים מוזיאון סקנדרבג בבניין מודרניסטי משנות ה-80 ומוזיאון אתנוגרפי בבית עות׳מאני מקורי. הרחוב המוביל אליה הוא בזאר משוחזר שמוכר שטיחים ועתיקות, חלקו אותנטי וחלקו לגמרי לתיירים. כשעה מטירנה.',
        rating: 4.2,
        durationMin: 180,
        tags: ['history'],
        priceLevel: 1,
    ...
    itinerary: [
      ...
      },
      {
        ...
        title: 'הליכה בהרים',
        placeIds: ['al-valbone'],
        notes: 'מסלול ואלבונה-תת הוא יום שלם. יש לתאם העברת ציוד ולינה בצד השני מראש.',
      },
      {
        day: 5,
        title: 'דרומה לקרויה',
        placeIds: ['al-kruje'],
        notes: 'נסיעה ארוכה חזרה דרך שקודרה. משם כשעה לשדה התעופה בטירנה.',
      },
    ],
    practical: {
      flights:
        'טיסות לטירנה, ישירות מתל אביב בעונה או עם חיבור באירופה. משדה התעופה כשעה וחצי נסיעה צפונה לשקודרה. אפשרות נוספת היא לנחות בפודגוריצה שבמונטנגרו, שקרובה יותר לאזור האגם, ולעבור את הגבול ביבשה.',
      gettingAround:
        'רכב שכור נוח לאזור השפלה, האגם וקרויה, אבל אינו מתאים לעמקי האלפים: הדרכים שם צרות ותלולות וחברות ההשכרה לרוב אוסרות נסיעה בהן. הדרך המקובלת להרים היא חניית הרכב בשקודרה, מעבורת אגם קומן, והמשך בטרנספר מקומי או בפורגון. המעבורת פועלת בעיקר בעונה, יוצאת פעם או פעמיים ביום ומתמלאת מראש. בהרים הכיסוי הסלולרי חלקי בלבד.',
      kosherOverview:
        'אין מסעדה או חנות כשרה בצפון אלבניה. הקהילה היהודית במדינה קטנה מאוד ומרוכזת בטירנה, שם יש נוכחות חב״ד, וכדאי לתאם מולה מראש כל אספקה לפני העלייה להרים - בכפרים אין שום אפשרות להשלים. אלבניה מוסלמית ברובה וחזיר נדיר יחסית באזורים המוסלמיים, אך נפוץ יותר בקהילות הקתוליות של שקודרה, והבשר בכל מקרה אינו כשר וכלי הבישול משותפים. הבסיס הצמחוני סביר: בורק, גבינות כפריות, יוגורט, שעועית, ירקות בגריל ופירות מצוינים, אך יש לברר על שומן ומרק בשר. חובה לוודא כל פרט בטלפון לפני הנסיעה.',
    },
  },
];
